...
\DoxyCodeLine{65 \textcolor{keyword}{struct }formatter<std::filesystem::path, Char>}
\DoxyCodeLine{66     : formatter<basic\_string\_view<Char>> \{}
...
\DoxyCodeLine{72     \textcolor{keywordflow}{return} formatter<basic\_string\_view<Char>>::format(}
...
\DoxyCodeLine{82 \textcolor{keyword}{struct }formatter<std::thread::id, Char> : basic\_ostream\_formatter<Char> \{\};}
...
\DoxyCodeLine{87 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }formatter<std::monostate, Char> \{}
...
\DoxyCodeLine{123   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} value =}
\DoxyCodeLine{124       \textcolor{keyword}{decltype}(check(variant\_index\_sequence<T>\{\}))::value;}
\DoxyCodeLine{125 \};}
\DoxyCodeLine{126 }
...
\DoxyCodeLine{129   \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (is\_string<T>::value)}
...
\DoxyCodeLine{140   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} value = detail::is\_variant\_like\_<T>::value;}
\DoxyCodeLine{141 \};}
\DoxyCodeLine{142 }
...
\DoxyCodeLine{144   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} value =}
...
\DoxyCodeLine{149 \textcolor{keyword}{struct }formatter<}
...
\DoxyCodeLine{159   \textcolor{keyword}{auto} format(\textcolor{keyword}{const} Variant\& value, FormatContext\& ctx) \textcolor{keyword}{const}}
