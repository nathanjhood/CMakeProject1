...
\DoxyCodeLine{51 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__std__string__like}{is\_std\_string\_like}} \{}
...
\DoxyCodeLine{58   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{59       \mbox{\hyperlink{structis__string}{is\_string<T>::value}} ||}
\DoxyCodeLine{60       std::is\_convertible<T, std\_string\_view<char>>\mbox{\hyperlink{classvalue}{::value}} ||}
\DoxyCodeLine{61       !std::is\_void<decltype(check<T>(\textcolor{keyword}{nullptr}))>\mbox{\hyperlink{classvalue}{::value}};}
\DoxyCodeLine{62 \};}
\DoxyCodeLine{63 }
\DoxyCodeLine{64 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char>}
\DoxyCodeLine{65 \textcolor{keyword}{struct }\mbox{\hyperlink{classdetail_1_1is__std__string__like}{is\_std\_string\_like}}<fmt::\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view}}<Char>> : std::true\_type \{\};}
\DoxyCodeLine{66 }
\DoxyCodeLine{67 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__map}{is\_map}} \{}
...
\DoxyCodeLine{73   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} = \textcolor{keyword}{false};}
\DoxyCodeLine{74 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{75   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{76       !std::is\_void<decltype(check<T>(\textcolor{keyword}{nullptr}))>\mbox{\hyperlink{classvalue}{::value}};}
\DoxyCodeLine{77 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{78 \};}
\DoxyCodeLine{79 }
\DoxyCodeLine{80 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__set}{is\_set}} \{}
...
\DoxyCodeLine{86   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} = \textcolor{keyword}{false};}
\DoxyCodeLine{87 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{88   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{89       !std::is\_void<decltype(check<T>(\textcolor{keyword}{nullptr}))>\mbox{\hyperlink{classvalue}{::value}} \&\& !\mbox{\hyperlink{classdetail_1_1is__map}{is\_map<T>::value}};}
\DoxyCodeLine{90 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{91 \};}
\DoxyCodeLine{92 }
\DoxyCodeLine{93 \textcolor{keyword}{template} <\textcolor{keyword}{typename}... Ts> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1conditional__helper}{conditional\_helper}} \{\};}
\DoxyCodeLine{94 }
\DoxyCodeLine{95 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} \_ = \textcolor{keywordtype}{void}> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1is__range__}{is\_range\_}} : std::false\_type \{\};}
\DoxyCodeLine{96 }
...
\DoxyCodeLine{116 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1has__member__fn__begin__end__t}{has\_member\_fn\_begin\_end\_t}} : std::false\_type \{\};}
\DoxyCodeLine{117 }
\DoxyCodeLine{118 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{119 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1has__member__fn__begin__end__t}{has\_member\_fn\_begin\_end\_t}}<T, void\_t<decltype(std::declval<T>().begin()),}
...
\DoxyCodeLine{144 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1has__const__begin__end}{has\_const\_begin\_end}} : std::false\_type \{\};}
...
\DoxyCodeLine{146 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1has__mutable__begin__end}{has\_mutable\_begin\_end}} : std::false\_type \{\};}
\DoxyCodeLine{147 }
\DoxyCodeLine{148 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{149 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1has__const__begin__end}{has\_const\_begin\_end}}<}
\DoxyCodeLine{150     T,}
...
\DoxyCodeLine{157 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1has__mutable__begin__end}{has\_mutable\_begin\_end}}<}
...
\DoxyCodeLine{164 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1is__range__}{is\_range\_}}<T, void>}
...
\DoxyCodeLine{171 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__tuple__like__}{is\_tuple\_like\_}} \{}
...
\DoxyCodeLine{177   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{178       !std::is\_void<decltype(check<T>(\textcolor{keyword}{nullptr}))>\mbox{\hyperlink{classvalue}{::value}};}
\DoxyCodeLine{179 \};}
\DoxyCodeLine{180 }
...
\DoxyCodeLine{184 \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}} = std::integer\_sequence<T, N...>;}
\DoxyCodeLine{185 \textcolor{keyword}{template} <\textcolor{keywordtype}{size\_t}... N> \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence}} = std::index\_sequence<N...>;}
\DoxyCodeLine{186 \textcolor{keyword}{template} <\textcolor{keywordtype}{size\_t} N> \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_index\_sequence}} = std::make\_index\_sequence<N>;}
\DoxyCodeLine{187 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{188 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, T... N> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}} \{}
...
\DoxyCodeLine{192 \};}
\DoxyCodeLine{193 }
\DoxyCodeLine{194 \textcolor{keyword}{template} <\textcolor{keywordtype}{size\_t}... N> \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence}} = \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<size\_t, N...>;}
\DoxyCodeLine{195 }
\DoxyCodeLine{196 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keywordtype}{size\_t} N, T... Ns>}
\DoxyCodeLine{197 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_integer\_sequence}} : \mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_integer\_sequence}}<T, N -\/ 1, N -\/ 1, Ns...> \{\};}
\DoxyCodeLine{198 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, T... Ns>}
\DoxyCodeLine{199 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_integer\_sequence}}<T, 0, Ns...> : \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<T, Ns...> \{\};}
\DoxyCodeLine{200 }
\DoxyCodeLine{201 \textcolor{keyword}{template} <\textcolor{keywordtype}{size\_t} N>}
\DoxyCodeLine{202 \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_index\_sequence}} = \mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_integer\_sequence<size\_t, N>}};}
\DoxyCodeLine{203 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{204 }
\DoxyCodeLine{205 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{206 \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1make__integer__sequence}{tuple\_index\_sequence}} = \mbox{\hyperlink{structdetail_1_1make__integer__sequence}{make\_index\_sequence<std::tuple\_size<T>::value}}>;}
\DoxyCodeLine{207 }
\DoxyCodeLine{208 template <typename T, typename C, bool = is\_tuple\_like\_<T>::value>}
\DoxyCodeLine{209 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__tuple__formattable__}{is\_tuple\_formattable\_}} \{}
\DoxyCodeLine{210  \textcolor{keyword}{public}:}
\DoxyCodeLine{211   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} = \textcolor{keyword}{false};}
\DoxyCodeLine{212 \};}
\DoxyCodeLine{213 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} C> \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__tuple__formattable__}{is\_tuple\_formattable\_}}<T, C, true> \{}
\DoxyCodeLine{214   \textcolor{keyword}{template} <std::size\_t... I>}
\DoxyCodeLine{215   \textcolor{keyword}{static} std::true\_type check2(\mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence<I...>}},}
\DoxyCodeLine{216                                \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<\textcolor{keywordtype}{bool}, (I == I)...>);}
...
\DoxyCodeLine{220       \mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence<I...>}}\{\},}
\DoxyCodeLine{221       \mbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<}
\DoxyCodeLine{222           bool, (is\_formattable<typename std::tuple\_element<I, T>::type,}
\DoxyCodeLine{223                                 C>\mbox{\hyperlink{classvalue}{::value}})...>\{\})) check(\mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence<I...>}});}
\DoxyCodeLine{224 }
\DoxyCodeLine{225  \textcolor{keyword}{public}:}
\DoxyCodeLine{226   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{227       \textcolor{keyword}{decltype}(check(\mbox{\hyperlink{structdetail_1_1make__integer__sequence}{tuple\_index\_sequence<T>}}\{\}))\mbox{\hyperlink{classvalue}{::value}};}
\DoxyCodeLine{228 \};}
\DoxyCodeLine{229 }
...
\DoxyCodeLine{231 \textcolor{keywordtype}{void} for\_each(\mbox{\hyperlink{structdetail_1_1integer__sequence}{index\_sequence<Is...>}}, Tuple\&\& tup, F\&\& f) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{292           FMT\_ENABLE\_IF(std::is\_convertible<T, \mbox{\hyperlink{structstd__string__view}{std\_string\_view<char>}}>\mbox{\hyperlink{classvalue}{::value}})>}
...
\DoxyCodeLine{294   \textcolor{keyword}{auto} sv = \mbox{\hyperlink{structstd__string__view}{std\_string\_view<Char>}}(str);}
...
\DoxyCodeLine{306     FMT\_ENABLE\_IF(!is\_std\_string\_like<\textcolor{keyword}{typename} std::decay<Arg>::type>\mbox{\hyperlink{classvalue}{::value}} \&\&}
...
\DoxyCodeLine{313 }
\DoxyCodeLine{314 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structis__tuple__like}{is\_tuple\_like}} \{}
\DoxyCodeLine{315   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{316       \mbox{\hyperlink{classdetail_1_1is__tuple__like__}{detail::is\_tuple\_like\_<T>::value}} \&\& !\mbox{\hyperlink{structdetail_1_1is__range__}{detail::is\_range\_<T>::value}};}
\DoxyCodeLine{317 \};}
\DoxyCodeLine{318 }
\DoxyCodeLine{319 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} C> \textcolor{keyword}{struct }\mbox{\hyperlink{structis__tuple__formattable}{is\_tuple\_formattable}} \{}
\DoxyCodeLine{320   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{321       \mbox{\hyperlink{classdetail_1_1is__tuple__formattable__}{detail::is\_tuple\_formattable\_<T, C>::value}};}
\DoxyCodeLine{322 \};}
\DoxyCodeLine{323 }
\DoxyCodeLine{324 \textcolor{keyword}{template} <\textcolor{keyword}{typename} TupleT, \textcolor{keyword}{typename} Char>}
\DoxyCodeLine{325 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<TupleT, Char,}
\DoxyCodeLine{326                  enable\_if\_t<fmt::\mbox{\hyperlink{structis__tuple__like}{is\_tuple\_like}}<TupleT>\mbox{\hyperlink{classvalue}{::value}} \&\&}
\DoxyCodeLine{327                              fmt::is\_tuple\_formattable<TupleT, Char>\mbox{\hyperlink{classvalue}{::value}}>> \{}
...
\DoxyCodeLine{355 \};}
\DoxyCodeLine{356 }
\DoxyCodeLine{357 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structis__range}{is\_range}} \{}
\DoxyCodeLine{358   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} =}
\DoxyCodeLine{359       \mbox{\hyperlink{structdetail_1_1is__range__}{detail::is\_range\_<T>::value}} \&\& !\mbox{\hyperlink{classdetail_1_1is__std__string__like}{detail::is\_std\_string\_like<T>::value}} \&\&}
\DoxyCodeLine{360       !\mbox{\hyperlink{classdetail_1_1is__map}{detail::is\_map<T>::value}} \&\&}
\DoxyCodeLine{361       !std::is\_convertible<T, std::basic\_string<Char>>\mbox{\hyperlink{classvalue}{::value}} \&\&}
\DoxyCodeLine{362       !std::is\_constructible<detail::std\_string\_view<Char>, T>\mbox{\hyperlink{classvalue}{::value}};}
\DoxyCodeLine{363 \};}
\DoxyCodeLine{364 }
\DoxyCodeLine{365 \textcolor{keyword}{namespace }detail \{}
\DoxyCodeLine{366 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1range__mapper}{range\_mapper}} \{}
\DoxyCodeLine{367   \textcolor{keyword}{using }\mbox{\hyperlink{structarg__mapper}{mapper}} = \mbox{\hyperlink{structarg__mapper}{arg\_mapper<Context>}};}
\DoxyCodeLine{368 }
\DoxyCodeLine{369   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T,}
\DoxyCodeLine{370             FMT\_ENABLE\_IF(has\_formatter<remove\_cvref\_t<T>, Context>\mbox{\hyperlink{classvalue}{::value}})>}
\DoxyCodeLine{371   \textcolor{keyword}{static} \textcolor{keyword}{auto} map(T\&\& \mbox{\hyperlink{classvalue}{value}}) -\/> T\&\& \{}
...
\DoxyCodeLine{375             FMT\_ENABLE\_IF(!has\_formatter<remove\_cvref\_t<T>, Context>\mbox{\hyperlink{classvalue}{::value}})>}
\DoxyCodeLine{376   \textcolor{keyword}{static} \textcolor{keyword}{auto} map(T\&\& \mbox{\hyperlink{classvalue}{value}})}
\DoxyCodeLine{377       -\/> \textcolor{keyword}{decltype}(\mbox{\hyperlink{structarg__mapper}{mapper}}().map(\textcolor{keyword}{static\_cast<}T\&\&\textcolor{keyword}{>}(\mbox{\hyperlink{classvalue}{value}}))) \{}
\DoxyCodeLine{378     \textcolor{keywordflow}{return} \mbox{\hyperlink{structarg__mapper}{mapper}}().map(\textcolor{keyword}{static\_cast<}T\&\&\textcolor{keyword}{>}(\mbox{\hyperlink{classvalue}{value}}));}
\DoxyCodeLine{379   \}}
\DoxyCodeLine{380 \};}
\DoxyCodeLine{381 }
...
\DoxyCodeLine{385     \mbox{\hyperlink{structformatter}{formatter}}<remove\_cvref\_t<\textcolor{keyword}{decltype}(\mbox{\hyperlink{structdetail_1_1range__mapper}{range\_mapper<buffer\_context<Char>}}>\{\}.map(}
\DoxyCodeLine{386                   std::declval<Element>()))>,}
\DoxyCodeLine{387               Char>,}
\DoxyCodeLine{388     \mbox{\hyperlink{structfallback__formatter}{fallback\_formatter<Element, Char>}}>;}
\DoxyCodeLine{389 }
...
\DoxyCodeLine{396 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<}
\DoxyCodeLine{397     R, Char,}
\DoxyCodeLine{398     enable\_if\_t<}
\DoxyCodeLine{399         \mbox{\hyperlink{structconjunction}{conjunction}}<fmt::\mbox{\hyperlink{structis__range}{is\_range}}<R, Char>}
...
\DoxyCodeLine{402         ,}
\DoxyCodeLine{403         \mbox{\hyperlink{structdisjunction}{disjunction}}<}
...
\DoxyCodeLine{410         >\mbox{\hyperlink{classvalue}{::value}}}
\DoxyCodeLine{411         >> \{}
\DoxyCodeLine{412 }
...
\DoxyCodeLine{461 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<}
\DoxyCodeLine{462     T, Char,}
\DoxyCodeLine{463     enable\_if\_t<\mbox{\hyperlink{structconjunction}{conjunction}}<detail::is\_map<T>}
...
\DoxyCodeLine{466         ,}
\DoxyCodeLine{467         \mbox{\hyperlink{structdisjunction}{disjunction}}<}
...
\DoxyCodeLine{470         >,}
\DoxyCodeLine{471         \mbox{\hyperlink{structdisjunction}{disjunction}}<}
...
\DoxyCodeLine{476     >\mbox{\hyperlink{classvalue}{::value}}}
\DoxyCodeLine{477     >> \{}
...
\DoxyCodeLine{486           std::is\_same<U, conditional\_t<\mbox{\hyperlink{structdetail_1_1has__const__begin__end}{detail::has\_const\_begin\_end<T>::value}},}
\DoxyCodeLine{487                                         \textcolor{keyword}{const} T, T>>\mbox{\hyperlink{classvalue}{::value}})>}
...
\DoxyCodeLine{503 \};}
\DoxyCodeLine{504 }
\DoxyCodeLine{505 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char, \textcolor{keyword}{typename}... T> \textcolor{keyword}{struct }\mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view}} : detail::view \{}
...
\DoxyCodeLine{508 }
\DoxyCodeLine{509   \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view}}(\textcolor{keyword}{const} std::tuple<T...>\& t, \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} s)}
...
\DoxyCodeLine{514 \textcolor{keyword}{using }\mbox{\hyperlink{structtuple__join__view}{tuple\_arg\_join}} = \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view}}<Char, T...>;}
\DoxyCodeLine{515 }
...
\DoxyCodeLine{524 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<\mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view}}<Char, T...>, Char> \{}
...
\DoxyCodeLine{531   \textcolor{keyword}{auto} format(\textcolor{keyword}{const} \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view<Char, T...>}}\& \mbox{\hyperlink{classvalue}{value}},}
...
\DoxyCodeLine{564   \textcolor{keyword}{auto} do\_format(\textcolor{keyword}{const} \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view<Char, T...>}}\&, FormatContext\& ctx,}
...
\DoxyCodeLine{571   \textcolor{keyword}{auto} do\_format(\textcolor{keyword}{const} \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view<Char, T...>}}\& \mbox{\hyperlink{classvalue}{value}}, FormatContext\& ctx,}
...
\DoxyCodeLine{600     -\/> \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view}}<char, T...> \{}
...
\DoxyCodeLine{607     -\/> \mbox{\hyperlink{structtuple__join__view}{tuple\_join\_view}}<wchar\_t, T...> \{}
...
\DoxyCodeLine{624     -\/> \mbox{\hyperlink{structjoin__view}{join\_view<const T*, const T*>}} \{}
