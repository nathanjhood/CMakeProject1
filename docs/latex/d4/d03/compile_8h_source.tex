...
\DoxyCodeLine{17 \textcolor{keyword}{inline} \mbox{\hyperlink{classcounting__iterator}{counting\_iterator}} copy\_str(InputIt begin, InputIt end,}
\DoxyCodeLine{18                                   \mbox{\hyperlink{classcounting__iterator}{counting\_iterator}} it) \{}
\DoxyCodeLine{19   \textcolor{keywordflow}{return} it + (end -\/ begin);}
\DoxyCodeLine{20 \}}
\DoxyCodeLine{21 }
\DoxyCodeLine{22 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt> \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base}} \{}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28   \mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base}}() : out\_(), limit\_(0) \{\}}
\DoxyCodeLine{29 }
\DoxyCodeLine{30   \mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base}}(OutputIt out, \textcolor{keywordtype}{size\_t} limit)}
...
\DoxyCodeLine{39   FMT\_UNCHECKED\_ITERATOR(\mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base}});}
\DoxyCodeLine{40 }
...
\DoxyCodeLine{50 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}};}
\DoxyCodeLine{51 }
\DoxyCodeLine{52 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt>}
\DoxyCodeLine{53 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}<OutputIt, std::false\_type>}
\DoxyCodeLine{54     : \textcolor{keyword}{public} \mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base}}<OutputIt> \{}
...
\DoxyCodeLine{59 }
\DoxyCodeLine{60   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{61 }
\DoxyCodeLine{62   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}(OutputIt out, \textcolor{keywordtype}{size\_t} limit)}
\DoxyCodeLine{63       : \mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base<OutputIt>}}(out, limit) \{\}}
\DoxyCodeLine{64 }
\DoxyCodeLine{65   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}\& operator++() \{}
...
\DoxyCodeLine{68   \}}
\DoxyCodeLine{69 }
\DoxyCodeLine{70   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}} operator++(\textcolor{keywordtype}{int}) \{}
...
\DoxyCodeLine{82 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}<OutputIt, std::true\_type>}
\DoxyCodeLine{83     : \textcolor{keyword}{public} \mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base}}<OutputIt> \{}
\DoxyCodeLine{84  \textcolor{keyword}{public}:}
\DoxyCodeLine{85   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{86 }
\DoxyCodeLine{87   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}(OutputIt out, \textcolor{keywordtype}{size\_t} limit)}
\DoxyCodeLine{88       : \mbox{\hyperlink{classdetail_1_1truncating__iterator__base}{truncating\_iterator\_base<OutputIt>}}(out, limit) \{\}}
\DoxyCodeLine{89 }
\DoxyCodeLine{90   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}\& operator=(T val) \{}
...
\DoxyCodeLine{93   \}}
\DoxyCodeLine{94 }
\DoxyCodeLine{95   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}\& operator++() \{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{96   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}\& operator++(\textcolor{keywordtype}{int}) \{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{97   \mbox{\hyperlink{classdetail_1_1truncating__iterator}{truncating\_iterator}}\& operator*() \{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{98 \};}
\DoxyCodeLine{99 }
\DoxyCodeLine{100 \textcolor{comment}{// A compile-\/time string which is compiled into fast formatting code.}}
\DoxyCodeLine{101 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1compiled__string}{compiled\_string}} \{\};}
\DoxyCodeLine{102 }
\DoxyCodeLine{103 \textcolor{keyword}{template} <\textcolor{keyword}{typename} S>}
\DoxyCodeLine{104 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1is__compiled__string}{is\_compiled\_string}} : std::is\_base\_of<compiled\_string, S> \{\};}
\DoxyCodeLine{105 }
...
\DoxyCodeLine{129 \textcolor{keyword}{struct }udl\_compiled\_string : \mbox{\hyperlink{classdetail_1_1compiled__string}{compiled\_string}} \{}
...
\DoxyCodeLine{138 \textcolor{keyword}{const} T\& first(\textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}}, \textcolor{keyword}{const} Tail\&...) \{}
\DoxyCodeLine{139   \textcolor{keywordflow}{return} \mbox{\hyperlink{classvalue}{value}};}
\DoxyCodeLine{140 \}}
\DoxyCodeLine{141 }
...
\DoxyCodeLine{175   \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} \mbox{\hyperlink{structdata}{data}};}
...
\DoxyCodeLine{180     \textcolor{keywordflow}{return} write<Char>(out, \mbox{\hyperlink{structdata}{data}});}
\DoxyCodeLine{181   \}}
\DoxyCodeLine{182 \};}
\DoxyCodeLine{183 }
...
\DoxyCodeLine{194   Char \mbox{\hyperlink{classvalue}{value}};}
...
\DoxyCodeLine{199     \textcolor{keywordflow}{return} write<Char>(out, \mbox{\hyperlink{classvalue}{value}});}
\DoxyCodeLine{200   \}}
\DoxyCodeLine{201 \};}
\DoxyCodeLine{202 }
...
\DoxyCodeLine{240     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{structis__named__arg}{is\_named\_arg<typename std::remove\_cv<T>::type}}>\mbox{\hyperlink{classvalue}{::value}}) \{}
...
\DoxyCodeLine{265   \mbox{\hyperlink{structformatter}{formatter<T, Char>}} fmt;}
\DoxyCodeLine{266 }
...
\DoxyCodeLine{272     \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context<OutputIt, Char>}} ctx(out, vargs);}
...
\DoxyCodeLine{329   \mbox{\hyperlink{structformatter}{formatter<T, Char>}} fmt;}
...
\DoxyCodeLine{340   \textcolor{keyword}{auto} ctx = \mbox{\hyperlink{classcompile__parse__context}{compile\_parse\_context<Char>}}(str, max\_value<int>(), \textcolor{keyword}{nullptr}, \{\},}
\DoxyCodeLine{341                                          next\_arg\_id);}
\DoxyCodeLine{342   \textcolor{keyword}{auto} f = \mbox{\hyperlink{structformatter}{formatter<T, Char>}}();}
...
\DoxyCodeLine{349   \mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}} arg\_id;}
\DoxyCodeLine{350 }
...
\DoxyCodeLine{356     arg\_id = \mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}}(\textcolor{keywordtype}{id});}
...
\DoxyCodeLine{360     arg\_id = \mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}}(\textcolor{keywordtype}{id});}
...
\DoxyCodeLine{370   \mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}} arg\_id;}
...
\DoxyCodeLine{376   \textcolor{keyword}{auto} handler = arg\_id\_handler<Char>\{\mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}}\{\}\};}
...
\DoxyCodeLine{386 \textcolor{keyword}{struct }field\_type<T, enable\_if\_t<detail::\mbox{\hyperlink{structis__named__arg}{is\_named\_arg}}<T>\mbox{\hyperlink{classvalue}{::value}}>> \{}
...
\DoxyCodeLine{482           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
...
\DoxyCodeLine{519           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
...
\DoxyCodeLine{527                         remove\_cvref\_t<\textcolor{keyword}{decltype}(first)>>\mbox{\hyperlink{classvalue}{::value}}) \{}
...
\DoxyCodeLine{546           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
...
\DoxyCodeLine{561           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
\DoxyCodeLine{562 \mbox{\hyperlink{structformat__to__n__result}{format\_to\_n\_result<OutputIt>}} format\_to\_n(OutputIt out, \textcolor{keywordtype}{size\_t} n,}
\DoxyCodeLine{563                                          \textcolor{keyword}{const} S\& format\_str, Args\&\&... args) \{}
\DoxyCodeLine{564   \textcolor{keyword}{auto} it = fmt::format\_to(\mbox{\hyperlink{classdetail_1_1truncating__iterator}{detail::truncating\_iterator<OutputIt>}}(out, n),}
...
\DoxyCodeLine{570           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
...
\DoxyCodeLine{577           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
...
\DoxyCodeLine{585           FMT\_ENABLE\_IF(\mbox{\hyperlink{structdetail_1_1is__compiled__string}{detail::is\_compiled\_string<S>::value}})>}
