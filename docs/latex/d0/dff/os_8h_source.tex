...
\DoxyCodeLine{122 }
\DoxyCodeLine{123 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<std::error\_code, Char> \{}
...
\DoxyCodeLine{224 \textcolor{keyword}{class }\mbox{\hyperlink{classbuffered__file}{buffered\_file}} \{}
...
\DoxyCodeLine{229 }
\DoxyCodeLine{230   \textcolor{keyword}{explicit} \mbox{\hyperlink{classbuffered__file}{buffered\_file}}(FILE* f) : file\_(f) \{\}}
\DoxyCodeLine{231 }
\DoxyCodeLine{232  \textcolor{keyword}{public}:}
\DoxyCodeLine{233   \mbox{\hyperlink{classbuffered__file}{buffered\_file}}(\textcolor{keyword}{const} \mbox{\hyperlink{classbuffered__file}{buffered\_file}}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{234   \textcolor{keywordtype}{void} operator=(\textcolor{keyword}{const} \mbox{\hyperlink{classbuffered__file}{buffered\_file}}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{235 }
\DoxyCodeLine{236   \textcolor{comment}{// Constructs a buffered\_file object which doesn't represent any file.}}
\DoxyCodeLine{237   \mbox{\hyperlink{classbuffered__file}{buffered\_file}}() noexcept : file\_(\textcolor{keyword}{nullptr}) \{\}}
\DoxyCodeLine{238 }
\DoxyCodeLine{239   \textcolor{comment}{// Destroys the object closing the file it represents if any.}}
\DoxyCodeLine{240   FMT\_API \mbox{\hyperlink{classbuffered__file}{\string~buffered\_file}}() \textcolor{keyword}{noexcept};}
\DoxyCodeLine{241 }
\DoxyCodeLine{242  \textcolor{keyword}{public}:}
\DoxyCodeLine{243   \mbox{\hyperlink{classbuffered__file}{buffered\_file}}(\mbox{\hyperlink{classbuffered__file}{buffered\_file}}\&\& other) noexcept : file\_(other.file\_) \{}
\DoxyCodeLine{244     other.file\_ = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{245   \}}
\DoxyCodeLine{246 }
\DoxyCodeLine{247   \mbox{\hyperlink{classbuffered__file}{buffered\_file}}\& operator=(\mbox{\hyperlink{classbuffered__file}{buffered\_file}}\&\& other) \{}
...
\DoxyCodeLine{255   FMT\_API \mbox{\hyperlink{classbuffered__file}{buffered\_file}}(\mbox{\hyperlink{classbasic__cstring__view}{cstring\_view}} filename, \mbox{\hyperlink{classbasic__cstring__view}{cstring\_view}} mode);}
\DoxyCodeLine{256 }
...
\DoxyCodeLine{261   FILE* get() \textcolor{keyword}{const} \textcolor{keyword}{noexcept} \{ \textcolor{keywordflow}{return} file\_; \}}
\DoxyCodeLine{262 }
...
\DoxyCodeLine{357   \mbox{\hyperlink{classbuffered__file}{buffered\_file}} fdopen(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* mode);}
\DoxyCodeLine{358 \};}
\DoxyCodeLine{359 }
...
\DoxyCodeLine{367   \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{classvalue}{value}} = 0;}
...
\DoxyCodeLine{396   ostream\_params(detail::buffer\_size bs) : buffer\_size(bs.\mbox{\hyperlink{classvalue}{value}}) \{\}}
...
\DoxyCodeLine{420       : detail::\mbox{\hyperlink{classbuffer}{buffer}}<char>(other.\mbox{\hyperlink{structdata}{data}}(), other.size(), other.capacity()),}
...
\DoxyCodeLine{427     \textcolor{keyword}{delete}[] \mbox{\hyperlink{structdata}{data}}();}
\DoxyCodeLine{428   \}}
\DoxyCodeLine{429 }
...
\DoxyCodeLine{432     file\_.write(\mbox{\hyperlink{structdata}{data}}(), size());}
