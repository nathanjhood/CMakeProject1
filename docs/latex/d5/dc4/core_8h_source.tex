...
\DoxyCodeLine{304 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structtype__identity}{type\_identity}} \{ \textcolor{keyword}{using }type = T; \};}
...
\DoxyCodeLine{308 }
\DoxyCodeLine{309 \textcolor{keyword}{template} <\textcolor{keyword}{typename}...> \textcolor{keyword}{struct }\mbox{\hyperlink{structdisjunction}{disjunction}} : std::false\_type \{\};}
\DoxyCodeLine{310 \textcolor{keyword}{template} <\textcolor{keyword}{typename} P> \textcolor{keyword}{struct }\mbox{\hyperlink{structdisjunction_3_01_p_01_4}{disjunction<P>}} : P \{\};}
\DoxyCodeLine{311 \textcolor{keyword}{template} <\textcolor{keyword}{typename} P1, \textcolor{keyword}{typename}... Pn>}
\DoxyCodeLine{312 \textcolor{keyword}{struct }\mbox{\hyperlink{structdisjunction}{disjunction}}<P1, Pn...>}
\DoxyCodeLine{313     : conditional\_t<bool(P1::value), P1, disjunction<Pn...>> \{\};}
\DoxyCodeLine{314 }
\DoxyCodeLine{315 \textcolor{keyword}{template} <\textcolor{keyword}{typename}...> \textcolor{keyword}{struct }\mbox{\hyperlink{structconjunction}{conjunction}} : std::true\_type \{\};}
\DoxyCodeLine{316 \textcolor{keyword}{template} <\textcolor{keyword}{typename} P> \textcolor{keyword}{struct }\mbox{\hyperlink{structconjunction_3_01_p_01_4}{conjunction<P>}} : P \{\};}
\DoxyCodeLine{317 \textcolor{keyword}{template} <\textcolor{keyword}{typename} P1, \textcolor{keyword}{typename}... Pn>}
\DoxyCodeLine{318 \textcolor{keyword}{struct }\mbox{\hyperlink{structconjunction}{conjunction}}<P1, Pn...>}
\DoxyCodeLine{319     : conditional\_t<bool(P1::value), conjunction<Pn...>, P1> \{\};}
\DoxyCodeLine{320 }
\DoxyCodeLine{321 \textcolor{keyword}{struct }\mbox{\hyperlink{structmonostate}{monostate}} \{}
\DoxyCodeLine{322   \textcolor{keyword}{constexpr} \mbox{\hyperlink{structmonostate}{monostate}}() \{\}}
\DoxyCodeLine{323 \};}
\DoxyCodeLine{324 }
...
\DoxyCodeLine{352 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{constexpr} FMT\_INLINE \textcolor{keyword}{auto} const\_check(T \mbox{\hyperlink{classvalue}{value}}) -\/> T \{}
\DoxyCodeLine{353   \textcolor{keywordflow}{return} \mbox{\hyperlink{classvalue}{value}};}
\DoxyCodeLine{354 \}}
\DoxyCodeLine{355 }
...
\DoxyCodeLine{373 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{using }\mbox{\hyperlink{structstd__string__view}{std\_string\_view}} = std::basic\_string\_view<Char>;}
...
\DoxyCodeLine{376 \textcolor{keyword}{using }\mbox{\hyperlink{structstd__string__view}{std\_string\_view}} = std::experimental::basic\_string\_view<Char>;}
\DoxyCodeLine{377 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{378 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structstd__string__view}{std\_string\_view}} \{\};}
...
\DoxyCodeLine{388 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{inline} \textcolor{keyword}{auto} convert\_for\_visit(T \mbox{\hyperlink{classvalue}{value}}) -\/> T \{}
\DoxyCodeLine{389   \textcolor{keywordflow}{return} \mbox{\hyperlink{classvalue}{value}};}
\DoxyCodeLine{390 \}}
...
\DoxyCodeLine{398 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{auto} convert\_for\_visit(T) -\/> \mbox{\hyperlink{structmonostate}{monostate}} \{ \textcolor{keywordflow}{return} \{\}; \}}
...
\DoxyCodeLine{403 FMT\_CONSTEXPR \textcolor{keyword}{auto} to\_unsigned(Int \mbox{\hyperlink{classvalue}{value}}) -\/>}
\DoxyCodeLine{404     \textcolor{keyword}{typename} std::make\_unsigned<Int>::type \{}
\DoxyCodeLine{405   FMT\_ASSERT(\mbox{\hyperlink{classvalue}{value}} >= 0, \textcolor{stringliteral}{"{}negative value"{}});}
\DoxyCodeLine{406   \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}typename std::make\_unsigned<Int>::type\textcolor{keyword}{>}(\mbox{\hyperlink{classvalue}{value}});}
\DoxyCodeLine{407 \}}
\DoxyCodeLine{408 }
...
\DoxyCodeLine{451         size\_(detail::const\_check(std::is\_same<Char, char>::\mbox{\hyperlink{classvalue}{value}} \&\&}
...
\DoxyCodeLine{463                                       S, detail::std\_string\_view<Char>>\mbox{\hyperlink{classvalue}{::value}})>}
...
\DoxyCodeLine{525 \textcolor{keyword}{struct }\mbox{\hyperlink{structcompile__string}{compile\_string}} \{\};}
\DoxyCodeLine{526 }
\DoxyCodeLine{527 \textcolor{keyword}{template} <\textcolor{keyword}{typename} S>}
\DoxyCodeLine{528 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__compile__string}{is\_compile\_string}} : std::is\_base\_of<compile\_string, S> \{\};}
\DoxyCodeLine{529 }
...
\DoxyCodeLine{546           FMT\_ENABLE\_IF(!std::is\_empty<\mbox{\hyperlink{structstd__string__view}{std\_string\_view<Char>}}>\mbox{\hyperlink{classvalue}{::value}})>}
\DoxyCodeLine{547 \textcolor{keyword}{inline} \textcolor{keyword}{auto} to\_string\_view(\mbox{\hyperlink{structstd__string__view}{std\_string\_view<Char>}} s) -\/> \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} \{}
...
\DoxyCodeLine{562 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__string}{is\_string}} : std::is\_class<decltype(to\_string\_view(std::declval<S>()))> \{}
\DoxyCodeLine{563 \};}
\DoxyCodeLine{564 }
\DoxyCodeLine{565 \textcolor{keyword}{template} <\textcolor{keyword}{typename} S, \textcolor{keyword}{typename} = \textcolor{keywordtype}{void}> \textcolor{keyword}{struct }\mbox{\hyperlink{structchar__t__impl}{char\_t\_impl}} \{\};}
\DoxyCodeLine{566 \textcolor{keyword}{template} <\textcolor{keyword}{typename} S> \textcolor{keyword}{struct }\mbox{\hyperlink{structchar__t__impl}{char\_t\_impl}}<S, enable\_if\_t<\mbox{\hyperlink{structis__string}{is\_string}}<S>::\mbox{\hyperlink{classvalue}{value}}>> \{}
...
\DoxyCodeLine{596 \textcolor{keyword}{struct }\mbox{\hyperlink{structtype__constant}{type\_constant}} : std::integral\_constant<type, type::custom\_type> \{\};}
\DoxyCodeLine{597 }
...
\DoxyCodeLine{627 }
\DoxyCodeLine{628 \textcolor{keyword}{struct }\mbox{\hyperlink{structerror__handler}{error\_handler}} \{}
\DoxyCodeLine{629   \textcolor{keyword}{constexpr} \mbox{\hyperlink{structerror__handler}{error\_handler}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{630   \textcolor{keyword}{constexpr} \mbox{\hyperlink{structerror__handler}{error\_handler}}(\textcolor{keyword}{const} \mbox{\hyperlink{structerror__handler}{error\_handler}}\&) = \textcolor{keywordflow}{default};}
\DoxyCodeLine{631 }
...
\DoxyCodeLine{715   \}}
\DoxyCodeLine{716 }
\DoxyCodeLine{717   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{structerror__handler}{error\_handler}}() const -\/> ErrorHandler \{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{718 \};}
\DoxyCodeLine{719 }
...
\DoxyCodeLine{725 \textcolor{keyword}{class }\mbox{\hyperlink{classcompile__parse__context}{compile\_parse\_context}}}
...
\DoxyCodeLine{730   \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__parse__context}{base}} = \mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char, ErrorHandler>}};}
\DoxyCodeLine{731 }
\DoxyCodeLine{732  \textcolor{keyword}{public}:}
\DoxyCodeLine{733   \textcolor{keyword}{explicit} FMT\_CONSTEXPR \mbox{\hyperlink{classcompile__parse__context}{compile\_parse\_context}}(}
...
\DoxyCodeLine{736       : \mbox{\hyperlink{classbasic__format__parse__context}{base}}(format\_str, eh, next\_arg\_id), num\_args\_(num\_args), types\_(types) \{\}}
\DoxyCodeLine{737 }
...
\DoxyCodeLine{739 }
\DoxyCodeLine{740   FMT\_CONSTEXPR \textcolor{keyword}{auto} next\_arg\_id() -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{744   \}}
\DoxyCodeLine{745 }
\DoxyCodeLine{746   FMT\_CONSTEXPR \textcolor{keywordtype}{void} check\_arg\_id(\textcolor{keywordtype}{int} \textcolor{keywordtype}{id}) \{}
...
\DoxyCodeLine{764 \}}
\DoxyCodeLine{765 }
\DoxyCodeLine{766 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{class }\mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg}};}
...
\DoxyCodeLine{772 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}} \{}
\DoxyCodeLine{773   \textcolor{comment}{// A deleted default constructor indicates a disabled formatter.}}
\DoxyCodeLine{774   \mbox{\hyperlink{structformatter}{formatter}}() = \textcolor{keyword}{delete};}
\DoxyCodeLine{775 \};}
\DoxyCodeLine{776 }
...
\DoxyCodeLine{784 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structis__contiguous}{is\_contiguous}} : std::false\_type \{\};}
\DoxyCodeLine{785 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char>}
\DoxyCodeLine{786 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__contiguous}{is\_contiguous}}<std::basic\_string<Char>> : std::true\_type \{\};}
\DoxyCodeLine{787 }
\DoxyCodeLine{788 \textcolor{keyword}{class }\mbox{\hyperlink{classappender}{appender}};}
\DoxyCodeLine{789 }
...
\DoxyCodeLine{829               std::is\_same<remove\_const\_t<T>, U>\mbox{\hyperlink{classvalue}{::value}}\&\& \mbox{\hyperlink{structis__char}{is\_char<U>::value}})>}
...
\DoxyCodeLine{910   \}}
\DoxyCodeLine{911 }
\DoxyCodeLine{912   FMT\_CONSTEXPR20 \textcolor{keywordtype}{void} push\_back(\textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}}) \{}
...
\DoxyCodeLine{927 \};}
\DoxyCodeLine{928 }
\DoxyCodeLine{929 \textcolor{keyword}{struct }\mbox{\hyperlink{structbuffer__traits}{buffer\_traits}} \{}
\DoxyCodeLine{930   \textcolor{keyword}{explicit} \mbox{\hyperlink{structbuffer__traits}{buffer\_traits}}(\textcolor{keywordtype}{size\_t}) \{\}}
\DoxyCodeLine{931   \textcolor{keyword}{auto} count() \textcolor{keyword}{const} -\/> \textcolor{keywordtype}{size\_t} \{ \textcolor{keywordflow}{return} 0; \}}
...
\DoxyCodeLine{933 \};}
\DoxyCodeLine{934 }
\DoxyCodeLine{935 \textcolor{keyword}{class }\mbox{\hyperlink{classfixed__buffer__traits}{fixed\_buffer\_traits}} \{}
...
\DoxyCodeLine{941   \textcolor{keyword}{explicit} \mbox{\hyperlink{classfixed__buffer__traits}{fixed\_buffer\_traits}}(\textcolor{keywordtype}{size\_t} limit) : limit\_(limit) \{\}}
\DoxyCodeLine{942   \textcolor{keyword}{auto} count() \textcolor{keyword}{const} -\/> \textcolor{keywordtype}{size\_t} \{ \textcolor{keywordflow}{return} count\_; \}}
...
\DoxyCodeLine{952 \textcolor{keyword}{class }\mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}} final : \textcolor{keyword}{public} Traits, \textcolor{keyword}{public} \mbox{\hyperlink{classbuffer}{buffer}}<T> \{}
...
\DoxyCodeLine{959   FMT\_CONSTEXPR20 \textcolor{keywordtype}{void} \mbox{\hyperlink{classiterator__buffer_af02ef23c0352b4d47071434233c8aeed}{grow}}(\textcolor{keywordtype}{size\_t})\textcolor{keyword}{ override }\{}
...
\DoxyCodeLine{970   \textcolor{keyword}{explicit} \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(OutputIt out, \textcolor{keywordtype}{size\_t} n = buffer\_size)}
\DoxyCodeLine{971       : Traits(n), \mbox{\hyperlink{classbuffer}{buffer}}<T>(data\_, 0, buffer\_size), out\_(out) \{\}}
\DoxyCodeLine{972   \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(\mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}\&\& other)}
\DoxyCodeLine{973       : Traits(other), \mbox{\hyperlink{classbuffer}{buffer}}<T>(data\_, 0, buffer\_size), out\_(other.out\_) \{\}}
\DoxyCodeLine{974   \mbox{\hyperlink{classiterator__buffer}{\string~iterator\_buffer}}() \{ flush(); \}}
\DoxyCodeLine{975 }
...
\DoxyCodeLine{984 \textcolor{keyword}{class }\mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}<T*, T, \mbox{\hyperlink{classfixed__buffer__traits}{fixed\_buffer\_traits}}> final}
\DoxyCodeLine{985     : \textcolor{keyword}{public} \mbox{\hyperlink{classfixed__buffer__traits}{fixed\_buffer\_traits}},}
...
\DoxyCodeLine{993   FMT\_CONSTEXPR20 \textcolor{keywordtype}{void} \mbox{\hyperlink{classiterator__buffer_3_01_t_01_5_00_01_t_00_01fixed__buffer__traits_01_4_abe39769721f1e487ced0052cc3172b6d}{grow}}(\textcolor{keywordtype}{size\_t})\textcolor{keyword}{ override }\{}
...
\DoxyCodeLine{1007   \textcolor{keyword}{explicit} \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(T* out, \textcolor{keywordtype}{size\_t} n = buffer\_size)}
...
\DoxyCodeLine{1009   \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(\mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}\&\& other)}
...
\DoxyCodeLine{1016     \}}
\DoxyCodeLine{1017   \}}
\DoxyCodeLine{1018   \mbox{\hyperlink{classiterator__buffer}{\string~iterator\_buffer}}() \{ flush(); \}}
\DoxyCodeLine{1019 }
...
\DoxyCodeLine{1027 \};}
\DoxyCodeLine{1028 }
\DoxyCodeLine{1029 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{class }\mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}<T*, T> final : \textcolor{keyword}{public} \mbox{\hyperlink{classbuffer}{buffer<T>}} \{}
\DoxyCodeLine{1030  \textcolor{keyword}{protected}:}
\DoxyCodeLine{1031   FMT\_CONSTEXPR20 \textcolor{keywordtype}{void} \mbox{\hyperlink{classiterator__buffer_3_01_t_01_5_00_01_t_01_4_a999c00e421733e68ed34cca800058897}{grow}}(\textcolor{keywordtype}{size\_t})\textcolor{keyword}{ override }\{\}}
\DoxyCodeLine{1032 }
\DoxyCodeLine{1033  \textcolor{keyword}{public}:}
\DoxyCodeLine{1034   \textcolor{keyword}{explicit} \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(T* out, \textcolor{keywordtype}{size\_t} = 0) : \mbox{\hyperlink{classbuffer}{buffer}}<T>(out, 0, \string~size\_t()) \{\}}
\DoxyCodeLine{1035 }
...
\DoxyCodeLine{1041 \textcolor{keyword}{class }\mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}<std::back\_insert\_iterator<Container>,}
...
\DoxyCodeLine{1055   \textcolor{keyword}{explicit} \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(Container\& c)}
...
\DoxyCodeLine{1057   \textcolor{keyword}{explicit} \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer}}(std::back\_insert\_iterator<Container> out, \textcolor{keywordtype}{size\_t} = 0)}
...
\DoxyCodeLine{1066 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T = \textcolor{keywordtype}{char}> \textcolor{keyword}{class }\mbox{\hyperlink{classcounting__buffer}{counting\_buffer}} final : \textcolor{keyword}{public} \mbox{\hyperlink{classbuffer}{buffer}}<T> \{}
...
\DoxyCodeLine{1073   FMT\_CONSTEXPR20 \textcolor{keywordtype}{void} \mbox{\hyperlink{classcounting__buffer_a52038490ed76389d50224146c86450dd}{grow}}(\textcolor{keywordtype}{size\_t})\textcolor{keyword}{ override }\{}
...
\DoxyCodeLine{1080   \mbox{\hyperlink{classcounting__buffer}{counting\_buffer}}() : \mbox{\hyperlink{classbuffer}{buffer}}<T>(data\_, 0, buffer\_size) \{\}}
\DoxyCodeLine{1081 }
...
\DoxyCodeLine{1086 \textcolor{keyword}{using }buffer\_appender = conditional\_t<std::is\_same<T, char>::value, \mbox{\hyperlink{classappender}{appender}},}
...
\DoxyCodeLine{1091 \textcolor{keyword}{auto} get\_buffer(OutputIt out) -\/> \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer<OutputIt, T>}} \{}
\DoxyCodeLine{1092   \textcolor{keywordflow}{return} \mbox{\hyperlink{classiterator__buffer}{iterator\_buffer<OutputIt, T>}}(out);}
\DoxyCodeLine{1093 \}}
\DoxyCodeLine{1094 }
...
\DoxyCodeLine{1104 \textcolor{keyword}{struct }\mbox{\hyperlink{structfallback__formatter}{fallback\_formatter}} \{}
\DoxyCodeLine{1105   \mbox{\hyperlink{structfallback__formatter}{fallback\_formatter}}() = \textcolor{keyword}{delete};}
\DoxyCodeLine{1106 \};}
\DoxyCodeLine{1107 }
...
\DoxyCodeLine{1116 }
\DoxyCodeLine{1117 \textcolor{keyword}{struct }\mbox{\hyperlink{structview}{view}} \{\};}
\DoxyCodeLine{1118 }
\DoxyCodeLine{1119 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char, \textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structnamed__arg}{named\_arg}} : \mbox{\hyperlink{structview}{view}} \{}
\DoxyCodeLine{1120   \textcolor{keyword}{const} Char* name;}
\DoxyCodeLine{1121   \textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}};}
\DoxyCodeLine{1122   \mbox{\hyperlink{structnamed__arg}{named\_arg}}(\textcolor{keyword}{const} Char* n, \textcolor{keyword}{const} T\& v) : name(n), \mbox{\hyperlink{classvalue}{value}}(v) \{\}}
\DoxyCodeLine{1123 \};}
\DoxyCodeLine{1124 }
\DoxyCodeLine{1125 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info}} \{}
...
\DoxyCodeLine{1131 \textcolor{keyword}{struct }\mbox{\hyperlink{structarg__data}{arg\_data}} \{}
...
\DoxyCodeLine{1135   \mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<Char>}} named\_args\_[NUM\_NAMED\_ARGS];}
\DoxyCodeLine{1136 }
\DoxyCodeLine{1137   \textcolor{keyword}{template} <\textcolor{keyword}{typename}... U>}
\DoxyCodeLine{1138   \mbox{\hyperlink{structarg__data}{arg\_data}}(\textcolor{keyword}{const} U\&... init) : args\_\{T(named\_args\_, NUM\_NAMED\_ARGS), init...\} \{\}}
\DoxyCodeLine{1139   \mbox{\hyperlink{structarg__data}{arg\_data}}(\textcolor{keyword}{const} \mbox{\hyperlink{structarg__data}{arg\_data}}\& other) = \textcolor{keyword}{delete};}
\DoxyCodeLine{1140   \textcolor{keyword}{auto} args() \textcolor{keyword}{const} -\/> \textcolor{keyword}{const} T* \{ \textcolor{keywordflow}{return} args\_ + 1; \}}
\DoxyCodeLine{1141   \textcolor{keyword}{auto} named\_args() -\/> \mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<Char>}}* \{ \textcolor{keywordflow}{return} named\_args\_; \}}
\DoxyCodeLine{1142 \};}
\DoxyCodeLine{1143 }
...
\DoxyCodeLine{1145 \textcolor{keyword}{struct }\mbox{\hyperlink{structarg__data}{arg\_data}}<T, Char, NUM\_ARGS, 0> \{}
...
\DoxyCodeLine{1150   FMT\_CONSTEXPR FMT\_INLINE \mbox{\hyperlink{structarg__data}{arg\_data}}(\textcolor{keyword}{const} U\&... init) : args\_\{init...\} \{\}}
\DoxyCodeLine{1151   FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} args() \textcolor{keyword}{const} -\/> \textcolor{keyword}{const} T* \{ \textcolor{keywordflow}{return} args\_; \}}
...
\DoxyCodeLine{1158 \textcolor{keyword}{inline} \textcolor{keywordtype}{void} init\_named\_args(\mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<Char>}}*, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int}) \{\}}
\DoxyCodeLine{1159 }
\DoxyCodeLine{1160 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structis__named__arg}{is\_named\_arg}} : std::false\_type \{\};}
\DoxyCodeLine{1161 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structis__statically__named__arg}{is\_statically\_named\_arg}} : std::false\_type \{\};}
\DoxyCodeLine{1162 }
\DoxyCodeLine{1163 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Char>}
\DoxyCodeLine{1164 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__named__arg}{is\_named\_arg}}<\mbox{\hyperlink{structnamed__arg}{named\_arg}}<Char, T>> : std::true\_type \{\};}
\DoxyCodeLine{1165 }
...
\DoxyCodeLine{1167           FMT\_ENABLE\_IF(!\mbox{\hyperlink{structis__named__arg}{is\_named\_arg<T>::value}})>}
\DoxyCodeLine{1168 \textcolor{keywordtype}{void} init\_named\_args(\mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<Char>}}* named\_args, \textcolor{keywordtype}{int} arg\_count,}
...
\DoxyCodeLine{1174           FMT\_ENABLE\_IF(\mbox{\hyperlink{structis__named__arg}{is\_named\_arg<T>::value}})>}
\DoxyCodeLine{1175 \textcolor{keywordtype}{void} init\_named\_args(\mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<Char>}}* named\_args, \textcolor{keywordtype}{int} arg\_count,}
...
\DoxyCodeLine{1197 \}}
\DoxyCodeLine{1198 }
\DoxyCodeLine{1199 \textcolor{keyword}{struct }\mbox{\hyperlink{structunformattable}{unformattable}} \{\};}
\DoxyCodeLine{1200 \textcolor{keyword}{struct }\mbox{\hyperlink{structunformattable__char}{unformattable\_char}} : \mbox{\hyperlink{structunformattable}{unformattable}} \{\};}
\DoxyCodeLine{1201 \textcolor{keyword}{struct }\mbox{\hyperlink{structunformattable__const}{unformattable\_const}} : \mbox{\hyperlink{structunformattable}{unformattable}} \{\};}
\DoxyCodeLine{1202 \textcolor{keyword}{struct }\mbox{\hyperlink{structunformattable__pointer}{unformattable\_pointer}} : \mbox{\hyperlink{structunformattable}{unformattable}} \{\};}
\DoxyCodeLine{1203 }
\DoxyCodeLine{1204 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structstring__value}{string\_value}} \{}
\DoxyCodeLine{1205   \textcolor{keyword}{const} Char* \mbox{\hyperlink{structdata}{data}};}
\DoxyCodeLine{1206   \textcolor{keywordtype}{size\_t} size;}
\DoxyCodeLine{1207 \};}
\DoxyCodeLine{1208 }
\DoxyCodeLine{1209 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structnamed__arg__value}{named\_arg\_value}} \{}
\DoxyCodeLine{1210   \textcolor{keyword}{const} \mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<Char>}}* \mbox{\hyperlink{structdata}{data}};}
\DoxyCodeLine{1211   \textcolor{keywordtype}{size\_t} size;}
\DoxyCodeLine{1212 \};}
\DoxyCodeLine{1213 }
\DoxyCodeLine{1214 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{struct }\mbox{\hyperlink{structcustom__value}{custom\_value}} \{}
\DoxyCodeLine{1215   \textcolor{keyword}{using }parse\_context = \textcolor{keyword}{typename} Context::parse\_context\_type;}
\DoxyCodeLine{1216   \textcolor{keywordtype}{void}* \mbox{\hyperlink{classvalue}{value}};}
...
\DoxyCodeLine{1221 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{class }\mbox{\hyperlink{classvalue}{value}} \{}
...
\DoxyCodeLine{1226     \mbox{\hyperlink{structmonostate}{monostate}} no\_value;}
...
\DoxyCodeLine{1239     \mbox{\hyperlink{structstring__value}{string\_value<char\_type>}} string;}
\DoxyCodeLine{1240     \mbox{\hyperlink{structcustom__value}{custom\_value<Context>}} custom;}
\DoxyCodeLine{1241     \mbox{\hyperlink{structnamed__arg__value}{named\_arg\_value<char\_type>}} named\_args;}
\DoxyCodeLine{1242   \};}
\DoxyCodeLine{1243 }
\DoxyCodeLine{1244   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}() : no\_value() \{\}}
\DoxyCodeLine{1245   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{int} val) : int\_value(val) \{\}}
\DoxyCodeLine{1246   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{unsigned} val) : uint\_value(val) \{\}}
\DoxyCodeLine{1247   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{long} \textcolor{keywordtype}{long} val) : long\_long\_value(val) \{\}}
\DoxyCodeLine{1248   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} val) : ulong\_long\_value(val) \{\}}
\DoxyCodeLine{1249   FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(int128\_opt val) : int128\_value(val) \{\}}
\DoxyCodeLine{1250   FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(uint128\_opt val) : uint128\_value(val) \{\}}
\DoxyCodeLine{1251   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{float} val) : float\_value(val) \{\}}
\DoxyCodeLine{1252   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{double} val) : double\_value(val) \{\}}
\DoxyCodeLine{1253   FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{long} \textcolor{keywordtype}{double} val) : long\_double\_value(val) \{\}}
\DoxyCodeLine{1254   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keywordtype}{bool} val) : bool\_value(val) \{\}}
\DoxyCodeLine{1255   \textcolor{keyword}{constexpr} FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(char\_type val) : char\_value(val) \{\}}
\DoxyCodeLine{1256   FMT\_CONSTEXPR FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keyword}{const} char\_type* val) \{}
...
\DoxyCodeLine{1259   \}}
\DoxyCodeLine{1260   FMT\_CONSTEXPR FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<char\_type>}} val) \{}
...
\DoxyCodeLine{1263   \}}
\DoxyCodeLine{1264   FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keyword}{const} \textcolor{keywordtype}{void}* val) : pointer(val) \{\}}
\DoxyCodeLine{1265   FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(\textcolor{keyword}{const} \mbox{\hyperlink{structnamed__arg__info}{named\_arg\_info<char\_type>}}* args, \textcolor{keywordtype}{size\_t} size)}
\DoxyCodeLine{1266       : named\_args\{args, size\} \{\}}
\DoxyCodeLine{1267 }
\DoxyCodeLine{1268   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> FMT\_CONSTEXPR FMT\_INLINE \mbox{\hyperlink{classvalue}{value}}(T\& val) \{}
...
\DoxyCodeLine{1279   \}}
\DoxyCodeLine{1280   \mbox{\hyperlink{classvalue}{value}}(\mbox{\hyperlink{structunformattable}{unformattable}});}
\DoxyCodeLine{1281   \mbox{\hyperlink{classvalue}{value}}(\mbox{\hyperlink{structunformattable__char}{unformattable\_char}});}
\DoxyCodeLine{1282   \mbox{\hyperlink{classvalue}{value}}(\mbox{\hyperlink{structunformattable__const}{unformattable\_const}});}
\DoxyCodeLine{1283   \mbox{\hyperlink{classvalue}{value}}(\mbox{\hyperlink{structunformattable__pointer}{unformattable\_pointer}});}
\DoxyCodeLine{1284 }
...
\DoxyCodeLine{1300 FMT\_CONSTEXPR \textcolor{keyword}{auto} make\_arg(T\&\& \mbox{\hyperlink{classvalue}{value}}) -\/> \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}};}
\DoxyCodeLine{1301 }
...
\DoxyCodeLine{1313 }
\DoxyCodeLine{1314 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structhas__format__as}{has\_format\_as}} \{}
...
\DoxyCodeLine{1319 }
\DoxyCodeLine{1320   \textcolor{keyword}{enum} \{ \mbox{\hyperlink{classvalue}{value}} = \textcolor{keyword}{decltype}(check(\textcolor{keyword}{static\_cast<}T*\textcolor{keyword}{>}(\textcolor{keyword}{nullptr})))\mbox{\hyperlink{classvalue}{::value}} \};}
\DoxyCodeLine{1321 \};}
\DoxyCodeLine{1322 }
...
\DoxyCodeLine{1326 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{struct }\mbox{\hyperlink{structarg__mapper}{arg\_mapper}} \{}
...
\DoxyCodeLine{1369   FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} map(T) -\/> \mbox{\hyperlink{structunformattable__char}{unformattable\_char}} \{}
...
\DoxyCodeLine{1386             FMT\_ENABLE\_IF(\mbox{\hyperlink{structis__string}{is\_string<T>::value}} \&\& !std::is\_pointer<T>::value \&\&}
\DoxyCodeLine{1387                           std::is\_same<char\_type, char\_t<T>>\mbox{\hyperlink{classvalue}{::value}})>}
...
\DoxyCodeLine{1393             FMT\_ENABLE\_IF(\mbox{\hyperlink{structis__string}{is\_string<T>::value}} \&\& !std::is\_pointer<T>::value \&\&}
\DoxyCodeLine{1394                           !std::is\_same<char\_type, char\_t<T>>\mbox{\hyperlink{classvalue}{::value}})>}
\DoxyCodeLine{1395   FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} map(\textcolor{keyword}{const} T\&) -\/> \mbox{\hyperlink{structunformattable__char}{unformattable\_char}} \{}
...
\DoxyCodeLine{1400                 std::is\_convertible<T, \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<char\_type>}}>\mbox{\hyperlink{classvalue}{::value}} \&\&}
\DoxyCodeLine{1401                 !\mbox{\hyperlink{structis__string}{is\_string<T>::value}} \&\& !has\_formatter<T, Context>::value \&\&}
...
\DoxyCodeLine{1409                 std::is\_convertible<T, \mbox{\hyperlink{structstd__string__view}{std\_string\_view<char\_type>}}>\mbox{\hyperlink{classvalue}{::value}} \&\&}
\DoxyCodeLine{1410                 !std::is\_convertible<T, \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<char\_type>}}>\mbox{\hyperlink{classvalue}{::value}} \&\&}
\DoxyCodeLine{1411                 !\mbox{\hyperlink{structis__string}{is\_string<T>::value}} \&\& !has\_formatter<T, Context>::value \&\&}
...
\DoxyCodeLine{1432           std::is\_function<\textcolor{keyword}{typename} std::remove\_pointer<T>::type>\mbox{\hyperlink{classvalue}{::value}} ||}
...
\DoxyCodeLine{1436   FMT\_CONSTEXPR \textcolor{keyword}{auto} map(\textcolor{keyword}{const} T\&) -\/> \mbox{\hyperlink{structunformattable__pointer}{unformattable\_pointer}} \{}
...
\DoxyCodeLine{1449                 !\mbox{\hyperlink{structhas__format__as}{has\_format\_as<T>::value}} \&\& !has\_formatter<T, Context>::value \&\&}
...
\DoxyCodeLine{1465   \textcolor{keyword}{struct }\mbox{\hyperlink{structarg__mapper_1_1formattable}{formattable}}}
...
\DoxyCodeLine{1482   FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} do\_map(T\&\&) -\/> \mbox{\hyperlink{structunformattable__const}{unformattable\_const}} \{}
...
\DoxyCodeLine{1500   FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} map(\textcolor{keyword}{const} T\& \mbox{\hyperlink{structnamed__arg}{named\_arg}})}
\DoxyCodeLine{1501       -\/> \textcolor{keyword}{decltype}(std::declval<arg\_mapper>().map(\mbox{\hyperlink{structnamed__arg}{named\_arg}}.value)) \{}
\DoxyCodeLine{1502     \textcolor{keywordflow}{return} map(\mbox{\hyperlink{structnamed__arg}{named\_arg}}.value);}
\DoxyCodeLine{1503   \}}
\DoxyCodeLine{1504 }
\DoxyCodeLine{1505   \textcolor{keyword}{auto} map(...) -\/> \mbox{\hyperlink{structunformattable}{unformattable}} \{ \textcolor{keywordflow}{return} \{\}; \}}
\DoxyCodeLine{1506 \};}
\DoxyCodeLine{1507 }
...
\DoxyCodeLine{1510 \textcolor{keyword}{using }\mbox{\hyperlink{structtype__constant}{mapped\_type\_constant}} =}
\DoxyCodeLine{1511     \mbox{\hyperlink{structtype__constant}{type\_constant<decltype(arg\_mapper<Context>}}().map(std::declval<const T\&>())),}
...
\DoxyCodeLine{1524 \textcolor{keyword}{class }\mbox{\hyperlink{classappender}{appender}} : \textcolor{keyword}{public} std::back\_insert\_iterator<detail::buffer<char>> \{}
...
\DoxyCodeLine{1528   \textcolor{keyword}{friend} \textcolor{keyword}{auto} get\_buffer(\mbox{\hyperlink{classappender}{appender}} out) -\/> detail::buffer<char>\& \{}
...
\DoxyCodeLine{1534   \mbox{\hyperlink{classappender}{appender}}(base it) noexcept : base(it) \{\}}
\DoxyCodeLine{1535   FMT\_UNCHECKED\_ITERATOR(\mbox{\hyperlink{classappender}{appender}});}
\DoxyCodeLine{1536 }
\DoxyCodeLine{1537   \textcolor{keyword}{auto} operator++() \textcolor{keyword}{noexcept} -\/> \mbox{\hyperlink{classappender}{appender}}\& \{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{1538   \textcolor{keyword}{auto} operator++(\textcolor{keywordtype}{int}) \textcolor{keyword}{noexcept} -\/> \mbox{\hyperlink{classappender}{appender}} \{ \textcolor{keywordflow}{return} *\textcolor{keyword}{this}; \}}
\DoxyCodeLine{1539 \};}
\DoxyCodeLine{1540 }
...
\DoxyCodeLine{1543 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{class }\mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg}} \{}
...
\DoxyCodeLine{1549   \textcolor{keyword}{friend} FMT\_CONSTEXPR \textcolor{keyword}{auto} detail::make\_arg(T\&\& \mbox{\hyperlink{classvalue}{value}})}
\DoxyCodeLine{1550       -\/> \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<ContextType>}};}
\DoxyCodeLine{1551 }
...
\DoxyCodeLine{1554                                              \textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Ctx>}}\& arg)}
...
\DoxyCodeLine{1564 }
\DoxyCodeLine{1565   \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg}}(\textcolor{keyword}{const} detail::named\_arg\_info<char\_type>* args, \textcolor{keywordtype}{size\_t} size)}
\DoxyCodeLine{1566       : value\_(args, size) \{\}}
\DoxyCodeLine{1567 }
\DoxyCodeLine{1568  \textcolor{keyword}{public}:}
\DoxyCodeLine{1569   \textcolor{keyword}{class }\mbox{\hyperlink{classbasic__format__arg_1_1handle}{handle}} \{}
\DoxyCodeLine{1570    \textcolor{keyword}{public}:}
\DoxyCodeLine{1571     \textcolor{keyword}{explicit} \mbox{\hyperlink{classbasic__format__arg_1_1handle}{handle}}(detail::custom\_value<Context> custom) : custom\_(custom) \{\}}
\DoxyCodeLine{1572 }
...
\DoxyCodeLine{1580   \};}
\DoxyCodeLine{1581 }
\DoxyCodeLine{1582   \textcolor{keyword}{constexpr} \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg}}() : type\_(detail::type::none\_type) \{\}}
\DoxyCodeLine{1583 }
...
\DoxyCodeLine{1589 }
\DoxyCodeLine{1590   \textcolor{keyword}{auto} \mbox{\hyperlink{structis__integral}{is\_integral}}() const -\/> \textcolor{keywordtype}{bool} \{ \textcolor{keywordflow}{return} detail::is\_integral\_type(type\_); \}}
...
\DoxyCodeLine{1605     Visitor\&\& vis, \textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}}\& arg) -\/> \textcolor{keyword}{decltype}(vis(0)) \{}
...
\DoxyCodeLine{1639     \textcolor{keywordflow}{return} vis(\textcolor{keyword}{typename} \mbox{\hyperlink{classbasic__format__arg_1_1handle}{basic\_format\_arg<Context>::handle}}(arg.value\_.custom));}
\DoxyCodeLine{1640   \}}
\DoxyCodeLine{1641   \textcolor{keywordflow}{return} vis(\mbox{\hyperlink{structmonostate}{monostate}}());}
\DoxyCodeLine{1642 \}}
\DoxyCodeLine{1643 }
...
\DoxyCodeLine{1647 \textcolor{keyword}{auto} copy\_str(InputIt begin, InputIt end, \mbox{\hyperlink{classappender}{appender}} out) -\/> \mbox{\hyperlink{classappender}{appender}} \{}
...
\DoxyCodeLine{1662 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__output__iterator}{is\_output\_iterator}} : std::false\_type \{\};}
\DoxyCodeLine{1663 }
\DoxyCodeLine{1664 \textcolor{keyword}{template} <\textcolor{keyword}{typename} It, \textcolor{keyword}{typename} T>}
\DoxyCodeLine{1665 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__output__iterator}{is\_output\_iterator}}<}
...
\DoxyCodeLine{1672 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__back__insert__iterator}{is\_back\_insert\_iterator}} : std::false\_type \{\};}
\DoxyCodeLine{1673 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Container>}
\DoxyCodeLine{1674 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__back__insert__iterator}{is\_back\_insert\_iterator<std::back\_insert\_iterator<Container>}}>}
\DoxyCodeLine{1675     : std::true\_type \{\};}
\DoxyCodeLine{1676 }
\DoxyCodeLine{1677 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt>}
\DoxyCodeLine{1678 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__contiguous__back__insert__iterator}{is\_contiguous\_back\_insert\_iterator}} : std::false\_type \{\};}
\DoxyCodeLine{1679 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Container>}
\DoxyCodeLine{1680 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__contiguous__back__insert__iterator}{is\_contiguous\_back\_insert\_iterator}}<std::back\_insert\_iterator<Container>>}
\DoxyCodeLine{1681     : \mbox{\hyperlink{structis__contiguous}{is\_contiguous}}<Container> \{\};}
\DoxyCodeLine{1682 \textcolor{keyword}{template} <>}
\DoxyCodeLine{1683 \textcolor{keyword}{struct }\mbox{\hyperlink{structis__contiguous__back__insert__iterator}{is\_contiguous\_back\_insert\_iterator}}<\mbox{\hyperlink{classappender}{appender}}> : std::true\_type \{\};}
\DoxyCodeLine{1684 }
\DoxyCodeLine{1685 \textcolor{comment}{// A type-\/erased reference to an std::locale to avoid a heavy <locale> include.}}
\DoxyCodeLine{1686 \textcolor{keyword}{class }\mbox{\hyperlink{classlocale__ref}{locale\_ref}} \{}
...
\DoxyCodeLine{1691   \textcolor{keyword}{constexpr} \mbox{\hyperlink{classlocale__ref}{locale\_ref}}() : locale\_(\textcolor{keyword}{nullptr}) \{\}}
\DoxyCodeLine{1692   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Locale> \textcolor{keyword}{explicit} \mbox{\hyperlink{classlocale__ref}{locale\_ref}}(\textcolor{keyword}{const} Locale\& loc);}
\DoxyCodeLine{1693 }
\DoxyCodeLine{1694   \textcolor{keyword}{explicit} \textcolor{keyword}{operator} bool() \textcolor{keyword}{const} \textcolor{keyword}{noexcept} \{ \textcolor{keywordflow}{return} locale\_ != \textcolor{keyword}{nullptr}; \}}
\DoxyCodeLine{1695 }
\DoxyCodeLine{1696   \textcolor{keyword}{template} <\textcolor{keyword}{typename} Locale> \textcolor{keyword}{auto} get() \textcolor{keyword}{const} -\/> Locale;}
\DoxyCodeLine{1697 \};}
\DoxyCodeLine{1698 }
\DoxyCodeLine{1699 \textcolor{keyword}{template} <\textcolor{keyword}{typename}> \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} encode\_types() -\/> \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \{}
...
\DoxyCodeLine{1705   \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{unsigned}\textcolor{keyword}{>}(\mbox{\hyperlink{structtype__constant}{mapped\_type\_constant<Arg, Context>::value}}) |}
...
\DoxyCodeLine{1710 FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} make\_value(T\&\& val) -\/> \mbox{\hyperlink{classvalue}{value<Context>}} \{}
\DoxyCodeLine{1711   \textcolor{keyword}{const} \textcolor{keyword}{auto}\& arg = \mbox{\hyperlink{structarg__mapper}{arg\_mapper<Context>}}().map(std::forward<T>(val));}
\DoxyCodeLine{1712 }
\DoxyCodeLine{1713   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} formattable\_char =}
\DoxyCodeLine{1714       !std::is\_same<\textcolor{keyword}{decltype}(arg), \textcolor{keyword}{const} \mbox{\hyperlink{structunformattable__char}{unformattable\_char}}\&>\mbox{\hyperlink{classvalue}{::value}};}
...
\DoxyCodeLine{1718       !std::is\_same<\textcolor{keyword}{decltype}(arg), \textcolor{keyword}{const} \mbox{\hyperlink{structunformattable__const}{unformattable\_const}}\&>\mbox{\hyperlink{classvalue}{::value}};}
...
\DoxyCodeLine{1726       !std::is\_same<\textcolor{keyword}{decltype}(arg), \textcolor{keyword}{const} \mbox{\hyperlink{structunformattable__pointer}{unformattable\_pointer}}\&>\mbox{\hyperlink{classvalue}{::value}};}
...
\DoxyCodeLine{1731       !std::is\_same<\textcolor{keyword}{decltype}(arg), \textcolor{keyword}{const} \mbox{\hyperlink{structunformattable}{unformattable}}\&>\mbox{\hyperlink{classvalue}{::value}};}
...
\DoxyCodeLine{1740 FMT\_CONSTEXPR \textcolor{keyword}{auto} make\_arg(T\&\& \mbox{\hyperlink{classvalue}{value}}) -\/> \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}} \{}
\DoxyCodeLine{1741   \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}} arg;}
\DoxyCodeLine{1742   arg.type\_ = \mbox{\hyperlink{structtype__constant}{mapped\_type\_constant<T, Context>::value}};}
\DoxyCodeLine{1743   arg.value\_ = make\_value<Context>(\mbox{\hyperlink{classvalue}{value}});}
...
\DoxyCodeLine{1752 FMT\_CONSTEXPR FMT\_INLINE \textcolor{keyword}{auto} make\_arg(T\&\& val) -\/> \mbox{\hyperlink{classvalue}{value<Context>}} \{}
...
\DoxyCodeLine{1758 FMT\_CONSTEXPR \textcolor{keyword}{inline} \textcolor{keyword}{auto} make\_arg(T\&\& \mbox{\hyperlink{classvalue}{value}}) -\/> \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}} \{}
\DoxyCodeLine{1759   \textcolor{keywordflow}{return} make\_arg<Context>(\mbox{\hyperlink{classvalue}{value}});}
\DoxyCodeLine{1760 \}}
\DoxyCodeLine{1761 FMT\_END\_DETAIL\_NAMESPACE}
\DoxyCodeLine{1762 }
\DoxyCodeLine{1763 \textcolor{comment}{// Formatting context.}}
\DoxyCodeLine{1764 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt, \textcolor{keyword}{typename} Char> \textcolor{keyword}{class }\mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}} \{}
\DoxyCodeLine{1765  \textcolor{keyword}{public}:}
\DoxyCodeLine{1767   \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__context_a71fea7d34edb618df612644dfd02a896}{char\_type}} = Char;}
\DoxyCodeLine{1768 }
...
\DoxyCodeLine{1776   \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__arg}{format\_arg}} = \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<basic\_format\_context>}};}
\DoxyCodeLine{1777   \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__parse__context}{parse\_context\_type}} = \mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context<Char>}};}
\DoxyCodeLine{1778   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{using }\mbox{\hyperlink{structformatter}{formatter\_type}} = \mbox{\hyperlink{structformatter}{formatter<T, char\_type>}};}
\DoxyCodeLine{1779 }
\DoxyCodeLine{1780   \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}}(\mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}}\&\&) = \textcolor{keywordflow}{default};}
\DoxyCodeLine{1781   \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}}(\textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{1782   \textcolor{keywordtype}{void} operator=(\textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}}\&) = \textcolor{keyword}{delete};}
\DoxyCodeLine{1787   \textcolor{keyword}{constexpr} \mbox{\hyperlink{classbasic__format__context_ac67f872e1b934d196fd3771773103339}{basic\_format\_context}}(}
...
\DoxyCodeLine{1798   \}}
\DoxyCodeLine{1799   \textcolor{keyword}{auto} args() const -\/> const \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}<\mbox{\hyperlink{classbasic__format__context}{basic\_format\_context}}>\& \{}
\DoxyCodeLine{1800     \textcolor{keywordflow}{return} args\_;}
\DoxyCodeLine{1801   \}}
\DoxyCodeLine{1802 }
\DoxyCodeLine{1803   FMT\_CONSTEXPR \textcolor{keyword}{auto} \mbox{\hyperlink{structerror__handler}{error\_handler}}() -\/> detail::error\_handler \{ \textcolor{keywordflow}{return} \{\}; \}}
\DoxyCodeLine{1804   \textcolor{keywordtype}{void} on\_error(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* message) \{ \mbox{\hyperlink{structerror__handler}{error\_handler}}().on\_error(message); \}}
\DoxyCodeLine{1805 }
...
\DoxyCodeLine{1818 \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__context}{buffer\_context}} =}
\DoxyCodeLine{1819     \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context<detail::buffer\_appender<Char>}}, Char>;}
\DoxyCodeLine{1820 \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__context}{format\_context}} = \mbox{\hyperlink{classbasic__format__context}{buffer\_context<char>}};}
\DoxyCodeLine{1821 }
...
\DoxyCodeLine{1830                          std::declval<T>()))>\mbox{\hyperlink{classvalue}{::value}} \&\&}
...
\DoxyCodeLine{1853                                    \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}}>;}
\DoxyCodeLine{1854 }
...
\DoxyCodeLine{1881 \};}
\DoxyCodeLine{1882 }
\DoxyCodeLine{1891 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context = \mbox{\hyperlink{classbasic__format__context}{format\_context}}, \textcolor{keyword}{typename}... Args>}
...
\DoxyCodeLine{1927   \textcolor{keyword}{using }\mbox{\hyperlink{classbasic__format__arg}{format\_arg}} = \mbox{\hyperlink{classbasic__format__arg}{basic\_format\_arg<Context>}};}
\DoxyCodeLine{1928 }
...
\DoxyCodeLine{1942     \textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__arg}{format\_arg}}* args\_;}
\DoxyCodeLine{1943   \};}
\DoxyCodeLine{1944 }
...
\DoxyCodeLine{1961   \textcolor{keyword}{constexpr} \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}(\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} desc, \textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__arg}{format\_arg}}* args)}
...
\DoxyCodeLine{1986       : \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}(store.get\_types(), store.\mbox{\hyperlink{structdata}{data}}()) \{\}}
\DoxyCodeLine{1987 }
\DoxyCodeLine{1993   \textcolor{keyword}{constexpr} \mbox{\hyperlink{classbasic__format__args_a1b6a098d11577f454964b51c2d7f9027}{basic\_format\_args}}(\textcolor{keyword}{const} \mbox{\hyperlink{classbasic__format__arg}{format\_arg}}* args, \textcolor{keywordtype}{int} count)}
...
\DoxyCodeLine{1996 }
\DoxyCodeLine{1998   FMT\_CONSTEXPR \textcolor{keyword}{auto} \mbox{\hyperlink{classbasic__format__args_a3339d3a4e4daaf7bb0de1a8084e7f086}{get}}(\textcolor{keywordtype}{int} \textcolor{keywordtype}{id}) \textcolor{keyword}{const} -\/> \mbox{\hyperlink{classbasic__format__arg}{format\_arg}} \{}
\DoxyCodeLine{1999     \mbox{\hyperlink{classbasic__format__arg}{format\_arg}} arg;}
...
\DoxyCodeLine{2012   \textcolor{keyword}{auto} \mbox{\hyperlink{classbasic__format__args_a3339d3a4e4daaf7bb0de1a8084e7f086}{get}}(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} name) \textcolor{keyword}{const} -\/> format\_arg \{}
...
\DoxyCodeLine{2062 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structfill__t}{fill\_t}} \{}
...
\DoxyCodeLine{2074   \}}
\DoxyCodeLine{2075 }
\DoxyCodeLine{2076   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} size() \textcolor{keyword}{const} -\/> \textcolor{keywordtype}{size\_t} \{ \textcolor{keywordflow}{return} size\_; \}}
\DoxyCodeLine{2077   \textcolor{keyword}{constexpr} \textcolor{keyword}{auto} \mbox{\hyperlink{structdata}{data}}() \textcolor{keyword}{const} -\/> \textcolor{keyword}{const} Char* \{ \textcolor{keywordflow}{return} data\_; \}}
\DoxyCodeLine{2078 }
...
\DoxyCodeLine{2110 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs}} \{}
...
\DoxyCodeLine{2119 }
\DoxyCodeLine{2120   \textcolor{keyword}{constexpr} \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs}}()}
...
\DoxyCodeLine{2128 \};}
\DoxyCodeLine{2129 }
\DoxyCodeLine{2130 \textcolor{keyword}{using }\mbox{\hyperlink{structbasic__format__specs}{format\_specs}} = \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs<char>}};}
\DoxyCodeLine{2131 }
...
\DoxyCodeLine{2137 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structarg__ref}{arg\_ref}} \{}
\DoxyCodeLine{2138   FMT\_CONSTEXPR \mbox{\hyperlink{structarg__ref}{arg\_ref}}() : kind(arg\_id\_kind::none), val() \{\}}
\DoxyCodeLine{2139 }
\DoxyCodeLine{2140   FMT\_CONSTEXPR \textcolor{keyword}{explicit} \mbox{\hyperlink{structarg__ref}{arg\_ref}}(\textcolor{keywordtype}{int} index)}
\DoxyCodeLine{2141       : kind(arg\_id\_kind::index), val(index) \{\}}
\DoxyCodeLine{2142   FMT\_CONSTEXPR \textcolor{keyword}{explicit} \mbox{\hyperlink{structarg__ref}{arg\_ref}}(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} name)}
\DoxyCodeLine{2143       : kind(arg\_id\_kind::name), val(name) \{\}}
\DoxyCodeLine{2144 }
\DoxyCodeLine{2145   FMT\_CONSTEXPR \textcolor{keyword}{auto} operator=(\textcolor{keywordtype}{int} idx) -\/> \mbox{\hyperlink{structarg__ref}{arg\_ref}}\& \{}
...
\DoxyCodeLine{2152   \textcolor{keyword}{union }\mbox{\hyperlink{unionarg__ref_1_1value}{value}} \{}
\DoxyCodeLine{2153     FMT\_CONSTEXPR \mbox{\hyperlink{unionarg__ref_1_1value}{value}}(\textcolor{keywordtype}{int} \textcolor{keywordtype}{id} = 0) : index\{\textcolor{keywordtype}{id}\} \{\}}
\DoxyCodeLine{2154     FMT\_CONSTEXPR \mbox{\hyperlink{unionarg__ref_1_1value}{value}}(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} n) : name(n) \{\}}
\DoxyCodeLine{2155 }
...
\DoxyCodeLine{2165 \textcolor{keyword}{struct }\mbox{\hyperlink{structdynamic__format__specs}{dynamic\_format\_specs}} : \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs}}<Char> \{}
\DoxyCodeLine{2166   \mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}} width\_ref;}
\DoxyCodeLine{2167   \mbox{\hyperlink{structarg__ref}{arg\_ref<Char>}} precision\_ref;}
\DoxyCodeLine{2168 \};}
\DoxyCodeLine{2169 }
\DoxyCodeLine{2170 \textcolor{keyword}{struct }\mbox{\hyperlink{structauto__id}{auto\_id}} \{\};}
\DoxyCodeLine{2171 }
\DoxyCodeLine{2172 \textcolor{comment}{// A format specifier handler that sets fields in basic\_format\_specs.}}
\DoxyCodeLine{2173 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{class }\mbox{\hyperlink{classspecs__setter}{specs\_setter}} \{}
\DoxyCodeLine{2174  \textcolor{keyword}{protected}:}
\DoxyCodeLine{2175   \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs<Char>}}\& specs\_;}
\DoxyCodeLine{2176 }
\DoxyCodeLine{2177  \textcolor{keyword}{public}:}
\DoxyCodeLine{2178   \textcolor{keyword}{explicit} FMT\_CONSTEXPR \mbox{\hyperlink{classspecs__setter}{specs\_setter}}(\mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs<Char>}}\& specs)}
\DoxyCodeLine{2179       : specs\_(specs) \{\}}
\DoxyCodeLine{2180 }
\DoxyCodeLine{2181   FMT\_CONSTEXPR \mbox{\hyperlink{classspecs__setter}{specs\_setter}}(\textcolor{keyword}{const} \mbox{\hyperlink{classspecs__setter}{specs\_setter}}\& other)}
...
\DoxyCodeLine{2209 \textcolor{keyword}{class }\mbox{\hyperlink{classdynamic__specs__handler}{dynamic\_specs\_handler}}}
\DoxyCodeLine{2210     : \textcolor{keyword}{public} \mbox{\hyperlink{classspecs__setter}{specs\_setter}}<typename ParseContext::char\_type> \{}
...
\DoxyCodeLine{2213 }
\DoxyCodeLine{2214   FMT\_CONSTEXPR \mbox{\hyperlink{classdynamic__specs__handler}{dynamic\_specs\_handler}}(\mbox{\hyperlink{structdynamic__format__specs}{dynamic\_format\_specs<char\_type>}}\& specs,}
...
\DoxyCodeLine{2217 }
\DoxyCodeLine{2218   FMT\_CONSTEXPR \mbox{\hyperlink{classdynamic__specs__handler}{dynamic\_specs\_handler}}(\textcolor{keyword}{const} \mbox{\hyperlink{classdynamic__specs__handler}{dynamic\_specs\_handler}}\& other)}
...
\DoxyCodeLine{2236   \mbox{\hyperlink{structdynamic__format__specs}{dynamic\_format\_specs<char\_type>}}\& specs\_;}
\DoxyCodeLine{2237   ParseContext\& context\_;}
\DoxyCodeLine{2238 }
\DoxyCodeLine{2239   \textcolor{keyword}{using }\mbox{\hyperlink{structarg__ref}{arg\_ref\_type}} = \mbox{\hyperlink{structarg__ref}{arg\_ref<char\_type>}};}
\DoxyCodeLine{2240 }
\DoxyCodeLine{2241   FMT\_CONSTEXPR \textcolor{keyword}{auto} make\_arg\_ref(\textcolor{keywordtype}{int} arg\_id) -\/> \mbox{\hyperlink{structarg__ref}{arg\_ref\_type}} \{}
\DoxyCodeLine{2242     context\_.check\_arg\_id(arg\_id);}
\DoxyCodeLine{2243     \textcolor{keywordflow}{return} \mbox{\hyperlink{structarg__ref}{arg\_ref\_type}}(arg\_id);}
\DoxyCodeLine{2244   \}}
\DoxyCodeLine{2245 }
\DoxyCodeLine{2246   FMT\_CONSTEXPR \textcolor{keyword}{auto} make\_arg\_ref(\mbox{\hyperlink{structauto__id}{auto\_id}}) -\/> \mbox{\hyperlink{structarg__ref}{arg\_ref\_type}} \{}
\DoxyCodeLine{2247     \textcolor{keywordflow}{return} \mbox{\hyperlink{structarg__ref}{arg\_ref\_type}}(context\_.next\_arg\_id());}
\DoxyCodeLine{2248   \}}
\DoxyCodeLine{2249 }
...
\DoxyCodeLine{2251       -\/> \mbox{\hyperlink{structarg__ref}{arg\_ref\_type}} \{}
...
\DoxyCodeLine{2255     \textcolor{keywordflow}{return} \mbox{\hyperlink{structarg__ref}{arg\_ref\_type}}(arg\_id);}
\DoxyCodeLine{2256   \}}
\DoxyCodeLine{2257 \};}
\DoxyCodeLine{2258 }
...
\DoxyCodeLine{2288 FMT\_CONSTEXPR \textcolor{keyword}{auto} find(Ptr first, Ptr last, T \mbox{\hyperlink{classvalue}{value}}, Ptr\& out) -\/> \textcolor{keywordtype}{bool} \{}
\DoxyCodeLine{2289   \textcolor{keywordflow}{for} (out = first; out != last; ++out) \{}
\DoxyCodeLine{2290     \textcolor{keywordflow}{if} (*out == \mbox{\hyperlink{classvalue}{value}}) \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{2291   \}}
\DoxyCodeLine{2292   \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{2293 \}}
\DoxyCodeLine{2294 }
\DoxyCodeLine{2295 \textcolor{keyword}{template} <>}
\DoxyCodeLine{2296 \textcolor{keyword}{inline} \textcolor{keyword}{auto} find<false, char>(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* first, \textcolor{keyword}{const} \textcolor{keywordtype}{char}* last, \textcolor{keywordtype}{char} \mbox{\hyperlink{classvalue}{value}},}
...
\DoxyCodeLine{2299       std::memchr(first, \mbox{\hyperlink{classvalue}{value}}, to\_unsigned(last -\/ first)));}
...
\DoxyCodeLine{2309   \textcolor{keywordtype}{unsigned} \mbox{\hyperlink{classvalue}{value}} = 0, prev = 0;}
\DoxyCodeLine{2310   \textcolor{keyword}{auto} p = begin;}
\DoxyCodeLine{2311   \textcolor{keywordflow}{do} \{}
\DoxyCodeLine{2312     prev = \mbox{\hyperlink{classvalue}{value}};}
\DoxyCodeLine{2313     \mbox{\hyperlink{classvalue}{value}} = \mbox{\hyperlink{classvalue}{value}} * 10 + unsigned(*p -\/ \textcolor{charliteral}{'0'});}
\DoxyCodeLine{2314     ++p;}
...
\DoxyCodeLine{2319     \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(\mbox{\hyperlink{classvalue}{value}});}
...
\DoxyCodeLine{2324              ? \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(\mbox{\hyperlink{classvalue}{value}})}
...
\DoxyCodeLine{2418 }
\DoxyCodeLine{2419     FMT\_CONSTEXPR \textcolor{keywordtype}{void} operator()() \{ handler.on\_dynamic\_width(\mbox{\hyperlink{structauto__id}{auto\_id}}()); \}}
...
\DoxyCodeLine{2452 }
\DoxyCodeLine{2453     FMT\_CONSTEXPR \textcolor{keywordtype}{void} operator()() \{ handler.on\_dynamic\_precision(\mbox{\hyperlink{structauto__id}{auto\_id}}()); \}}
...
\DoxyCodeLine{2694 \}}
\DoxyCodeLine{2695 }
\DoxyCodeLine{2696 template <typename T, bool = is\_named\_arg<T>::value> \textcolor{keyword}{struct }\mbox{\hyperlink{structstrip__named__arg}{strip\_named\_arg}} \{}
\DoxyCodeLine{2697   \textcolor{keyword}{using }type = T;}
\DoxyCodeLine{2698 \};}
\DoxyCodeLine{2699 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structstrip__named__arg}{strip\_named\_arg}}<T, true> \{}
...
\DoxyCodeLine{2707   \textcolor{keyword}{using }context = \mbox{\hyperlink{classbasic__format__context}{buffer\_context<char\_type>}};}
...
\DoxyCodeLine{2710       \mbox{\hyperlink{structtype__constant}{mapped\_type\_constant<T, context>::value}} != type::custom\_type,}
\DoxyCodeLine{2711       \textcolor{keyword}{decltype}(\mbox{\hyperlink{structarg__mapper}{arg\_mapper<context>}}().map(std::declval<const T\&>())),}
...
\DoxyCodeLine{2714                          \mbox{\hyperlink{structformatter}{formatter<mapped\_type, char\_type>}},}
\DoxyCodeLine{2715                          \mbox{\hyperlink{structfallback__formatter}{fallback\_formatter<stripped\_type, char\_type>}}>();}
...
\DoxyCodeLine{2728 FMT\_CONSTEXPR \textcolor{keyword}{auto} check\_char\_specs(\textcolor{keyword}{const} \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs<Char>}}\& specs,}
...
\DoxyCodeLine{2747 \};}
\DoxyCodeLine{2748 }
\DoxyCodeLine{2749 \textcolor{keyword}{struct }\mbox{\hyperlink{structfloat__specs}{float\_specs}} \{}
...
\DoxyCodeLine{2760 FMT\_CONSTEXPR \textcolor{keyword}{auto} parse\_float\_type\_spec(\textcolor{keyword}{const} \mbox{\hyperlink{structbasic__format__specs}{basic\_format\_specs<Char>}}\& specs,}
\DoxyCodeLine{2761                                          ErrorHandler\&\& eh = \{\})}
\DoxyCodeLine{2762     -\/> \mbox{\hyperlink{structfloat__specs}{float\_specs}} \{}
\DoxyCodeLine{2763   \textcolor{keyword}{auto} result = \mbox{\hyperlink{structfloat__specs}{float\_specs}}();}
...
\DoxyCodeLine{2829 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Handler> \textcolor{keyword}{class }\mbox{\hyperlink{classspecs__checker}{specs\_checker}} : \textcolor{keyword}{public} Handler \{}
...
\DoxyCodeLine{2839   FMT\_CONSTEXPR \mbox{\hyperlink{classspecs__checker}{specs\_checker}}(\textcolor{keyword}{const} Handler\& handler, detail::type arg\_type)}
...
\DoxyCodeLine{2904 \textcolor{keyword}{class }\mbox{\hyperlink{classformat__string__checker}{format\_string\_checker}} \{}
...
\DoxyCodeLine{2909   \textcolor{keyword}{using }\mbox{\hyperlink{classcompile__parse__context}{parse\_context\_type}} = \mbox{\hyperlink{classcompile__parse__context}{compile\_parse\_context<Char, ErrorHandler>}};}
...
\DoxyCodeLine{2913   \textcolor{keyword}{using }parse\_func = \textcolor{keyword}{const} Char* (*)(\mbox{\hyperlink{classcompile__parse__context}{parse\_context\_type}}\&);}
\DoxyCodeLine{2914 }
\DoxyCodeLine{2915   \mbox{\hyperlink{classcompile__parse__context}{parse\_context\_type}} context\_;}
...
\DoxyCodeLine{2920   \textcolor{keyword}{explicit} FMT\_CONSTEXPR \mbox{\hyperlink{classformat__string__checker}{format\_string\_checker}}(}
...
\DoxyCodeLine{2959 \textcolor{keyword}{template} <\textcolor{keyword}{typename}..., \textcolor{keyword}{typename} S, FMT\_ENABLE\_IF(!\mbox{\hyperlink{structis__compile__string}{is\_compile\_string<S>::value}})>}
...
\DoxyCodeLine{2962   \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{structis__compile__string}{is\_compile\_string<S>::value}},}
...
\DoxyCodeLine{2968           FMT\_ENABLE\_IF(\mbox{\hyperlink{structis__compile__string}{is\_compile\_string<S>::value}})>}
...
\DoxyCodeLine{2971   \textcolor{keyword}{using }checker = \mbox{\hyperlink{classformat__string__checker}{format\_string\_checker}}<\textcolor{keyword}{typename} S::char\_type, \mbox{\hyperlink{structerror__handler}{error\_handler}},}
...
\DoxyCodeLine{2982     \mbox{\hyperlink{classlocale__ref}{locale\_ref}} loc = \{\});}
\DoxyCodeLine{2983 }
...
\DoxyCodeLine{2993 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<T, Char,}
\DoxyCodeLine{2994                  enable\_if\_t<detail::\mbox{\hyperlink{structtype__constant}{type\_constant}}<T, Char>\mbox{\hyperlink{classvalue}{::value}} !=}
...
\DoxyCodeLine{3093 }
\DoxyCodeLine{3094 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }\mbox{\hyperlink{structbasic__runtime}{basic\_runtime}} \{ \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} str; \};}
\DoxyCodeLine{3095 }
...
\DoxyCodeLine{3104                 std::is\_convertible<\textcolor{keyword}{const} S\&, \mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}}>\mbox{\hyperlink{classvalue}{::value}})>}
...
\DoxyCodeLine{3121   \}}
\DoxyCodeLine{3122   \mbox{\hyperlink{classbasic__format__string}{basic\_format\_string}}(\mbox{\hyperlink{structbasic__runtime}{basic\_runtime<Char>}} r) : str\_(r.str) \{\}}
\DoxyCodeLine{3123 }
...
\DoxyCodeLine{3144 \textcolor{keyword}{inline} \textcolor{keyword}{auto} runtime(\mbox{\hyperlink{classbasic__string__view}{string\_view}} s) -\/> \mbox{\hyperlink{structbasic__runtime}{basic\_runtime<char>}} \{ \textcolor{keywordflow}{return} \{\{s\}\}; \}}
...
\DoxyCodeLine{3193 \}}
\DoxyCodeLine{3194 }
\DoxyCodeLine{3195 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt> \textcolor{keyword}{struct }\mbox{\hyperlink{structformat__to__n__result}{format\_to\_n\_result}} \{}
\DoxyCodeLine{3197   OutputIt \mbox{\hyperlink{structformat__to__n__result_a90597c6c1d23c7301aef16e756c6263b}{out}};}
\DoxyCodeLine{3199   \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{structformat__to__n__result_ab1c815078e1a78716bb07b9ed8c7023b}{size}};}
\DoxyCodeLine{3200 \};}
\DoxyCodeLine{3201 }
...
\DoxyCodeLine{3205     -\/> \mbox{\hyperlink{structformat__to__n__result}{format\_to\_n\_result<OutputIt>}} \{}
...
\DoxyCodeLine{3223                             T\&\&... args) -\/> \mbox{\hyperlink{structformat__to__n__result}{format\_to\_n\_result<OutputIt>}} \{}
