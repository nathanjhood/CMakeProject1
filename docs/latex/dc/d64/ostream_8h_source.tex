...
\DoxyCodeLine{17 }
\DoxyCodeLine{18 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt, \textcolor{keyword}{typename} Char> \textcolor{keyword}{class }\mbox{\hyperlink{classbasic__printf__context}{basic\_printf\_context}};}
\DoxyCodeLine{19 }
...
\DoxyCodeLine{24 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1is__streamable}{is\_streamable}} \{}
...
\DoxyCodeLine{36   \mbox{\hyperlink{classdetail_1_1is__streamable}{is\_streamable}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{37 }
\DoxyCodeLine{38   \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{bool} \mbox{\hyperlink{classvalue}{value}} = result::value;}
\DoxyCodeLine{39 \};}
\DoxyCodeLine{40 }
...
\DoxyCodeLine{44 \textcolor{keyword}{struct }\mbox{\hyperlink{classdetail_1_1is__streamable}{is\_streamable}}<}
\DoxyCodeLine{45     T, Char,}
\DoxyCodeLine{46     enable\_if\_t<}
\DoxyCodeLine{47         std::is\_arithmetic<T>\mbox{\hyperlink{classvalue}{::value}} || std::is\_array<T>\mbox{\hyperlink{classvalue}{::value}} ||}
\DoxyCodeLine{48         std::is\_pointer<T>\mbox{\hyperlink{classvalue}{::value}} || std::is\_same<T, char8\_type>\mbox{\hyperlink{classvalue}{::value}} ||}
\DoxyCodeLine{49         std::is\_convertible<T, fmt::basic\_string\_view<Char>>\mbox{\hyperlink{classvalue}{::value}} ||}
\DoxyCodeLine{50         std::is\_same<T, std\_string\_view<Char>>\mbox{\hyperlink{classvalue}{::value}} ||}
...
\DoxyCodeLine{56 \}}
\DoxyCodeLine{57 }
\DoxyCodeLine{58 \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1dummy__filebuf}{dummy\_filebuf}} \{}
\DoxyCodeLine{59   FILE* \_Myfile;}
\DoxyCodeLine{60 \};}
\DoxyCodeLine{61 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} U = \textcolor{keywordtype}{int}> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1ms__filebuf}{ms\_filebuf}} \{}
\DoxyCodeLine{62   \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1dummy__filebuf}{type}} = \mbox{\hyperlink{structdetail_1_1dummy__filebuf}{dummy\_filebuf}};}
\DoxyCodeLine{63 \};}
\DoxyCodeLine{64 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1ms__filebuf}{ms\_filebuf}}<T, decltype(T::\_Myfile, 0)> \{}
\DoxyCodeLine{65   \textcolor{keyword}{using }type = T;}
\DoxyCodeLine{66 \};}
\DoxyCodeLine{67 \textcolor{keyword}{using }\mbox{\hyperlink{structdetail_1_1dummy__filebuf}{filebuf\_type}} = \mbox{\hyperlink{structdetail_1_1dummy__filebuf}{ms\_filebuf<std::filebuf>::type}};}
\DoxyCodeLine{68 }
\DoxyCodeLine{69 FILE* get\_file(\mbox{\hyperlink{structdetail_1_1dummy__filebuf}{filebuf\_type}}\& buf);}
\DoxyCodeLine{70 }
...
\DoxyCodeLine{77 \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1filebuf__access}{filebuf\_access}} \{}
\DoxyCodeLine{78   \textcolor{keyword}{friend} FILE* get\_file(\mbox{\hyperlink{structdetail_1_1dummy__filebuf}{filebuf\_type}}\& buf) \{ \textcolor{keywordflow}{return} buf.*file; \}}
\DoxyCodeLine{79 \};}
\DoxyCodeLine{80 \textcolor{keyword}{template} \textcolor{keyword}{class }\mbox{\hyperlink{classdetail_1_1filebuf__access}{filebuf\_access}}<filebuf\_access\_tag,}
\DoxyCodeLine{81                               \textcolor{keyword}{decltype}(\&filebuf\_type::\_Myfile),}
\DoxyCodeLine{82                               \&filebuf\_type::\_Myfile>;}
\DoxyCodeLine{83 }
\DoxyCodeLine{84 \textcolor{keyword}{inline} \textcolor{keywordtype}{bool} write(std::filebuf\& buf, fmt::string\_view \mbox{\hyperlink{structdata}{data}}) \{}
...
\DoxyCodeLine{87   print(f, \mbox{\hyperlink{structdata}{data}});}
...
\DoxyCodeLine{115 \textcolor{keywordtype}{void} format\_value(\mbox{\hyperlink{classbuffer}{buffer<Char>}}\& buf, \textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}},}
\DoxyCodeLine{116                   \mbox{\hyperlink{classlocale__ref}{locale\_ref}} loc = \mbox{\hyperlink{classlocale__ref}{locale\_ref}}()) \{}
...
\DoxyCodeLine{122   output << \mbox{\hyperlink{classvalue}{value}};}
\DoxyCodeLine{123   output.exceptions(std::ios\_base::failbit | std::ios\_base::badbit);}
\DoxyCodeLine{124 \}}
\DoxyCodeLine{125 }
\DoxyCodeLine{126 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }\mbox{\hyperlink{structdetail_1_1streamed__view}{streamed\_view}} \{ \textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}}; \};}
\DoxyCodeLine{127 }
...
\DoxyCodeLine{132 \textcolor{keyword}{struct }\mbox{\hyperlink{structbasic__ostream__formatter}{basic\_ostream\_formatter}} : \mbox{\hyperlink{structformatter}{formatter}}<basic\_string\_view<Char>, Char> \{}
\DoxyCodeLine{133   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} OutputIt>}
\DoxyCodeLine{134   \textcolor{keyword}{auto} format(\textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}}, \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context<OutputIt, Char>}}\& ctx) \textcolor{keyword}{const}}
...
\DoxyCodeLine{141 \};}
\DoxyCodeLine{142 }
\DoxyCodeLine{143 \textcolor{keyword}{using }\mbox{\hyperlink{structbasic__ostream__formatter}{ostream\_formatter}} = \mbox{\hyperlink{structbasic__ostream__formatter}{basic\_ostream\_formatter<char>}};}
\DoxyCodeLine{144 }
\DoxyCodeLine{145 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{146 \textcolor{keyword}{struct }\mbox{\hyperlink{structformatter}{formatter}}<detail::streamed\_view<T>> : \mbox{\hyperlink{structbasic__ostream__formatter}{ostream\_formatter}} \{}
\DoxyCodeLine{147   \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt>}
\DoxyCodeLine{148   \textcolor{keyword}{auto} format(\mbox{\hyperlink{structdetail_1_1streamed__view}{detail::streamed\_view<T>}} \mbox{\hyperlink{structview}{view}},}
\DoxyCodeLine{149               \mbox{\hyperlink{classbasic__format__context}{basic\_format\_context<OutputIt, char>}}\& ctx) \textcolor{keyword}{const} -\/> OutputIt \{}
...
\DoxyCodeLine{165 \textcolor{keyword}{auto} streamed(\textcolor{keyword}{const} T\& \mbox{\hyperlink{classvalue}{value}}) -\/> \mbox{\hyperlink{structdetail_1_1streamed__view}{detail::streamed\_view<T>}} \{}
\DoxyCodeLine{166   \textcolor{keywordflow}{return} \{\mbox{\hyperlink{classvalue}{value}}\};}
\DoxyCodeLine{167 \}}
\DoxyCodeLine{168 }
...
\DoxyCodeLine{173 \textcolor{keyword}{struct }\mbox{\hyperlink{structfallback__formatter}{fallback\_formatter}}<T, Char, enable\_if\_t<\mbox{\hyperlink{classdetail_1_1is__streamable}{is\_streamable}}<T, Char>::\mbox{\hyperlink{classvalue}{value}}>>}
\DoxyCodeLine{174     : \mbox{\hyperlink{structbasic__ostream__formatter}{basic\_ostream\_formatter}}<Char> \{}
\DoxyCodeLine{175   \textcolor{keyword}{using }\mbox{\hyperlink{structbasic__ostream__formatter}{basic\_ostream\_formatter}}<Char>::format;}
\DoxyCodeLine{176 \};}
\DoxyCodeLine{177 }
...
\DoxyCodeLine{183             \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}<\mbox{\hyperlink{classbasic__format__context}{buffer\_context}}<type\_identity\_t<Char>>> args) \{}
...
\DoxyCodeLine{208   vprint(os, fmt, fmt::make\_format\_args<\mbox{\hyperlink{classbasic__format__context}{buffer\_context<wchar\_t>}}>(args...));}
\DoxyCodeLine{209 \}}
\DoxyCodeLine{210 }
