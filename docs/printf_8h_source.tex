...
\DoxyCodeLine{18 }
\DoxyCodeLine{19 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }printf\_formatter \{ printf\_formatter() = \textcolor{keyword}{delete}; \};}
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char>}
\DoxyCodeLine{22 \textcolor{keyword}{class }basic\_printf\_parse\_context : \textcolor{keyword}{public} \mbox{\hyperlink{classbasic__format__parse__context}{basic\_format\_parse\_context}}<Char> \{}
...
\DoxyCodeLine{24 \};}
\DoxyCodeLine{25 }
\DoxyCodeLine{26 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt, \textcolor{keyword}{typename} Char> \textcolor{keyword}{class }basic\_printf\_context \{}
...
\DoxyCodeLine{33   \textcolor{keyword}{using }format\_arg = basic\_format\_arg<basic\_printf\_context>;}
\DoxyCodeLine{34   \textcolor{keyword}{using }parse\_context\_type = basic\_printf\_parse\_context<Char>;}
\DoxyCodeLine{35   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{using }formatter\_type = printf\_formatter<T>;}
\DoxyCodeLine{36 }
\DoxyCodeLine{43   basic\_printf\_context(OutputIt out,}
...
\DoxyCodeLine{63 \textcolor{keyword}{template} <\textcolor{keywordtype}{bool} IsSigned> \textcolor{keyword}{struct }int\_checker \{}
\DoxyCodeLine{64   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{static} \textcolor{keywordtype}{bool} fits\_in\_int(T value) \{}
\DoxyCodeLine{65     \textcolor{keywordtype}{unsigned} max = max\_value<int>();}
\DoxyCodeLine{66     \textcolor{keywordflow}{return} value <= max;}
\DoxyCodeLine{67   \}}
...
\DoxyCodeLine{69 \};}
\DoxyCodeLine{70 }
\DoxyCodeLine{71 \textcolor{keyword}{template} <> \textcolor{keyword}{struct }int\_checker<true> \{}
\DoxyCodeLine{72   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{static} \textcolor{keywordtype}{bool} fits\_in\_int(T value) \{}
\DoxyCodeLine{73     \textcolor{keywordflow}{return} value >= (std::numeric\_limits<int>::min)() \&\&}
\DoxyCodeLine{74            value <= max\_value<int>();}
\DoxyCodeLine{75   \}}
...
\DoxyCodeLine{77 \};}
\DoxyCodeLine{78 }
\DoxyCodeLine{79 \textcolor{keyword}{class }printf\_precision\_handler \{}
...
\DoxyCodeLine{82   \textcolor{keywordtype}{int} operator()(T value) \{}
\DoxyCodeLine{83     \textcolor{keywordflow}{if} (!int\_checker<std::numeric\_limits<T>::is\_signed>::fits\_in\_int(value))}
\DoxyCodeLine{84       FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}number is too big"{}}));}
\DoxyCodeLine{85     \textcolor{keywordflow}{return} (std::max)(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(value), 0);}
\DoxyCodeLine{86   \}}
\DoxyCodeLine{87 }
...
\DoxyCodeLine{96 \textcolor{keyword}{class }is\_zero\_int \{}
...
\DoxyCodeLine{99   \textcolor{keywordtype}{bool} operator()(T value) \{}
\DoxyCodeLine{100     \textcolor{keywordflow}{return} value == 0;}
\DoxyCodeLine{101   \}}
\DoxyCodeLine{102 }
...
\DoxyCodeLine{107 \};}
\DoxyCodeLine{108 }
\DoxyCodeLine{109 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }make\_unsigned\_or\_bool : std::make\_unsigned<T> \{\};}
\DoxyCodeLine{110 }
\DoxyCodeLine{111 \textcolor{keyword}{template} <> \textcolor{keyword}{struct }make\_unsigned\_or\_bool<bool> \{ \textcolor{keyword}{using }type = bool; \};}
\DoxyCodeLine{112 }
\DoxyCodeLine{113 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T, \textcolor{keyword}{typename} Context> \textcolor{keyword}{class }arg\_converter \{}
...
\DoxyCodeLine{116 }
\DoxyCodeLine{117   basic\_format\_arg<Context>\& arg\_;}
\DoxyCodeLine{118   char\_type type\_;}
\DoxyCodeLine{119 }
\DoxyCodeLine{120  \textcolor{keyword}{public}:}
\DoxyCodeLine{121   arg\_converter(basic\_format\_arg<Context>\& arg, char\_type type)}
\DoxyCodeLine{122       : arg\_(arg), type\_(type) \{\}}
\DoxyCodeLine{123 }
\DoxyCodeLine{124   \textcolor{keywordtype}{void} operator()(\textcolor{keywordtype}{bool} value) \{}
\DoxyCodeLine{125     \textcolor{keywordflow}{if} (type\_ != \textcolor{charliteral}{'s'}) operator()<\textcolor{keywordtype}{bool}>(value);}
\DoxyCodeLine{126   \}}
\DoxyCodeLine{127 }
...
\DoxyCodeLine{129   \textcolor{keywordtype}{void} operator()(U value) \{}
...
\DoxyCodeLine{136             \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(\textcolor{keyword}{static\_cast<}target\_type\textcolor{keyword}{>}(value)));}
\DoxyCodeLine{137       \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{138         \textcolor{keyword}{using }unsigned\_type = \textcolor{keyword}{typename} make\_unsigned\_or\_bool<target\_type>::type;}
\DoxyCodeLine{139         arg\_ = detail::make\_arg<Context>(}
\DoxyCodeLine{140             \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{unsigned}\textcolor{keyword}{>}(\textcolor{keyword}{static\_cast<}unsigned\_type\textcolor{keyword}{>}(value)));}
\DoxyCodeLine{141       \}}
...
\DoxyCodeLine{147         arg\_ = detail::make\_arg<Context>(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{long} \textcolor{keywordtype}{long}\textcolor{keyword}{>}(value));}
\DoxyCodeLine{148       \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{149         arg\_ = detail::make\_arg<Context>(}
\DoxyCodeLine{150             \textcolor{keyword}{static\_cast<}typename make\_unsigned\_or\_bool<U>::type\textcolor{keyword}{>}(value));}
\DoxyCodeLine{151       \}}
\DoxyCodeLine{152     \}}
\DoxyCodeLine{153   \}}
\DoxyCodeLine{154 }
...
\DoxyCodeLine{164 \textcolor{keywordtype}{void} convert\_arg(basic\_format\_arg<Context>\& arg, Char type) \{}
\DoxyCodeLine{165   visit\_format\_arg(arg\_converter<T, Context>(arg, type), arg);}
\DoxyCodeLine{166 \}}
\DoxyCodeLine{167 }
\DoxyCodeLine{168 \textcolor{comment}{// Converts an integer argument to char for printf.}}
\DoxyCodeLine{169 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Context> \textcolor{keyword}{class }char\_converter \{}
\DoxyCodeLine{170  \textcolor{keyword}{private}:}
\DoxyCodeLine{171   basic\_format\_arg<Context>\& arg\_;}
\DoxyCodeLine{172 }
\DoxyCodeLine{173  \textcolor{keyword}{public}:}
\DoxyCodeLine{174   \textcolor{keyword}{explicit} char\_converter(basic\_format\_arg<Context>\& arg) : arg\_(arg) \{\}}
\DoxyCodeLine{175 }
...
\DoxyCodeLine{177   \textcolor{keywordtype}{void} operator()(T value) \{}
\DoxyCodeLine{178     arg\_ = detail::make\_arg<Context>(}
\DoxyCodeLine{179         \textcolor{keyword}{static\_cast<}typename Context::char\_type\textcolor{keyword}{>}(value));}
\DoxyCodeLine{180   \}}
\DoxyCodeLine{181 }
...
\DoxyCodeLine{188 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }get\_cstring \{}
...
\DoxyCodeLine{195 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{class }printf\_width\_handler \{}
\DoxyCodeLine{196  \textcolor{keyword}{private}:}
\DoxyCodeLine{197   \textcolor{keyword}{using }format\_specs = basic\_format\_specs<Char>;}
\DoxyCodeLine{198 }
\DoxyCodeLine{199   format\_specs\& specs\_;}
\DoxyCodeLine{200 }
\DoxyCodeLine{201  \textcolor{keyword}{public}:}
\DoxyCodeLine{202   \textcolor{keyword}{explicit} printf\_width\_handler(format\_specs\& specs) : specs\_(specs) \{\}}
\DoxyCodeLine{203 }
...
\DoxyCodeLine{205   \textcolor{keywordtype}{unsigned} operator()(T value) \{}
\DoxyCodeLine{206     \textcolor{keyword}{auto} width = \textcolor{keyword}{static\_cast<}uint32\_or\_64\_or\_128\_t<T>\textcolor{keyword}{>}(value);}
\DoxyCodeLine{207     \textcolor{keywordflow}{if} (detail::is\_negative(value)) \{}
...
\DoxyCodeLine{225 \textcolor{keyword}{class }printf\_arg\_formatter : \textcolor{keyword}{public} arg\_formatter<Char> \{}
\DoxyCodeLine{226  \textcolor{keyword}{private}:}
\DoxyCodeLine{227   \textcolor{keyword}{using }base = arg\_formatter<Char>;}
\DoxyCodeLine{228   \textcolor{keyword}{using }context\_type = basic\_printf\_context<OutputIt, Char>;}
\DoxyCodeLine{229   \textcolor{keyword}{using }format\_specs = basic\_format\_specs<Char>;}
\DoxyCodeLine{230 }
\DoxyCodeLine{231   context\_type\& context\_;}
\DoxyCodeLine{232 }
\DoxyCodeLine{233   OutputIt write\_null\_pointer(\textcolor{keywordtype}{bool} is\_string = \textcolor{keyword}{false}) \{}
\DoxyCodeLine{234     \textcolor{keyword}{auto} s = this-\/>specs;}
\DoxyCodeLine{235     s.type = presentation\_type::none;}
\DoxyCodeLine{236     \textcolor{keywordflow}{return} write\_bytes(this-\/>out, is\_string ? \textcolor{stringliteral}{"{}(null)"{}} : \textcolor{stringliteral}{"{}(nil)"{}}, s);}
\DoxyCodeLine{237   \}}
\DoxyCodeLine{238 }
\DoxyCodeLine{239  \textcolor{keyword}{public}:}
\DoxyCodeLine{240   printf\_arg\_formatter(OutputIt iter, format\_specs\& s, context\_type\& ctx)}
\DoxyCodeLine{241       : base\{iter, s, locale\_ref()\}, context\_(ctx) \{\}}
\DoxyCodeLine{242 }
\DoxyCodeLine{243   OutputIt operator()(monostate value) \{ \textcolor{keywordflow}{return} base::operator()(value); \}}
\DoxyCodeLine{244 }
...
\DoxyCodeLine{246   OutputIt operator()(T value) \{}
...
\DoxyCodeLine{250       format\_specs fmt\_specs = this-\/>specs;}
...
\DoxyCodeLine{253         \textcolor{keywordflow}{return} (*\textcolor{keyword}{this})(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(value));}
\DoxyCodeLine{254       \}}
...
\DoxyCodeLine{262       \textcolor{keywordflow}{return} write<Char>(this-\/>out, \textcolor{keyword}{static\_cast<}Char\textcolor{keyword}{>}(value), fmt\_specs);}
\DoxyCodeLine{263     \}}
\DoxyCodeLine{264     \textcolor{keywordflow}{return} base::operator()(value);}
\DoxyCodeLine{265   \}}
\DoxyCodeLine{266 }
...
\DoxyCodeLine{268   OutputIt operator()(T value) \{}
\DoxyCodeLine{269     \textcolor{keywordflow}{return} base::operator()(value);}
\DoxyCodeLine{270   \}}
\DoxyCodeLine{271 }
\DoxyCodeLine{273   OutputIt operator()(\textcolor{keyword}{const} \textcolor{keywordtype}{char}* value) \{}
\DoxyCodeLine{274     \textcolor{keywordflow}{if} (value) \textcolor{keywordflow}{return} base::operator()(value);}
\DoxyCodeLine{275     \textcolor{keywordflow}{return} write\_null\_pointer(this-\/>specs.type != presentation\_type::pointer);}
\DoxyCodeLine{276   \}}
\DoxyCodeLine{277 }
\DoxyCodeLine{279   OutputIt operator()(\textcolor{keyword}{const} \textcolor{keywordtype}{wchar\_t}* value) \{}
\DoxyCodeLine{280     \textcolor{keywordflow}{if} (value) \textcolor{keywordflow}{return} base::operator()(value);}
\DoxyCodeLine{281     \textcolor{keywordflow}{return} write\_null\_pointer(this-\/>specs.type != presentation\_type::pointer);}
\DoxyCodeLine{282   \}}
\DoxyCodeLine{283 }
\DoxyCodeLine{284   OutputIt operator()(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}} value) \{}
\DoxyCodeLine{285     \textcolor{keywordflow}{return} base::operator()(value);}
\DoxyCodeLine{286   \}}
\DoxyCodeLine{287 }
\DoxyCodeLine{289   OutputIt operator()(\textcolor{keyword}{const} \textcolor{keywordtype}{void}* value) \{}
\DoxyCodeLine{290     \textcolor{keywordflow}{return} value ? base::operator()(value) : write\_null\_pointer();}
\DoxyCodeLine{291   \}}
\DoxyCodeLine{292 }
\DoxyCodeLine{294   OutputIt operator()(\textcolor{keyword}{typename} basic\_format\_arg<context\_type>::handle handle) \{}
\DoxyCodeLine{295     \textcolor{keyword}{auto} parse\_ctx =}
\DoxyCodeLine{296         basic\_printf\_parse\_context<Char>(\mbox{\hyperlink{classbasic__string__view}{basic\_string\_view<Char>}}());}
...
\DoxyCodeLine{303 \textcolor{keywordtype}{void} parse\_flags(basic\_format\_specs<Char>\& specs, \textcolor{keyword}{const} Char*\& it,}
...
\DoxyCodeLine{332                  basic\_format\_specs<Char>\& specs, GetArg get\_arg) \{}
...
\DoxyCodeLine{338     \textcolor{keywordtype}{int} value = parse\_nonnegative\_int(it, end, -\/1);}
\DoxyCodeLine{339     \textcolor{keywordflow}{if} (it != end \&\& *it == \textcolor{charliteral}{'\$'}) \{  \textcolor{comment}{// value is an argument index}}
\DoxyCodeLine{340       ++it;}
\DoxyCodeLine{341       arg\_index = value != -\/1 ? value : max\_value<int>();}
...
\DoxyCodeLine{344       \textcolor{keywordflow}{if} (value != 0) \{}
...
\DoxyCodeLine{347         \textcolor{keywordflow}{if} (value == -\/1) FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}number is too big"{}}));}
\DoxyCodeLine{348         specs.width = value;}
...
\DoxyCodeLine{373   \textcolor{keyword}{auto} context = basic\_printf\_context<OutputIt, Char>(out, args);}
\DoxyCodeLine{374   \textcolor{keyword}{auto} parse\_ctx = basic\_printf\_parse\_context<Char>(format);}
\DoxyCodeLine{375 }
...
\DoxyCodeLine{403 }
\DoxyCodeLine{404     basic\_format\_specs<Char> specs;}
...
\DoxyCodeLine{504             detail::char\_converter<basic\_printf\_context<OutputIt, Char>>(arg),}
...
\DoxyCodeLine{524 \textcolor{keyword}{using }basic\_printf\_context\_t =}
\DoxyCodeLine{525     basic\_printf\_context<detail::buffer\_appender<Char>, Char>;}
\DoxyCodeLine{526 }
\DoxyCodeLine{527 \textcolor{keyword}{using }printf\_context = basic\_printf\_context\_t<char>;}
\DoxyCodeLine{528 \textcolor{keyword}{using }wprintf\_context = basic\_printf\_context\_t<wchar\_t>;}
\DoxyCodeLine{529 }
...
\DoxyCodeLine{541     -\/> \mbox{\hyperlink{classformat__arg__store}{format\_arg\_store}}<printf\_context, T...> \{}
...
\DoxyCodeLine{553     -\/> \mbox{\hyperlink{classformat__arg__store}{format\_arg\_store}}<wprintf\_context, T...> \{}
...
\DoxyCodeLine{560     \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}<basic\_printf\_context\_t<type\_identity\_t<Char>>> args)}
...
\DoxyCodeLine{579   \textcolor{keyword}{using }context = basic\_printf\_context\_t<Char>;}
...
\DoxyCodeLine{587     \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}<basic\_printf\_context\_t<type\_identity\_t<Char>>> args)}
...
\DoxyCodeLine{608   \textcolor{keyword}{using }context = basic\_printf\_context\_t<Char>;}
...
\DoxyCodeLine{616     \mbox{\hyperlink{classbasic__format__args}{basic\_format\_args}}<basic\_printf\_context\_t<type\_identity\_t<Char>>> args)}
...
\DoxyCodeLine{634       fmt::make\_format\_args<basic\_printf\_context\_t<char\_t<S>>>(args...));}
\DoxyCodeLine{635 \}}
\DoxyCodeLine{636 }
