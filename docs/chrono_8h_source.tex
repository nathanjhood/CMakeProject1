...
\DoxyCodeLine{304 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T = \textcolor{keywordtype}{void}> \textcolor{keyword}{struct }null \{\};}
\DoxyCodeLine{305 \textcolor{keyword}{inline} null<> localtime\_r FMT\_NOMACRO(...) \{ \textcolor{keywordflow}{return} null<>(); \}}
...
\DoxyCodeLine{313 \}}
\DoxyCodeLine{314 }
\DoxyCodeLine{315 \textcolor{keyword}{template} <\textcolor{keyword}{typename} CodeUnit> \textcolor{keyword}{struct }codecvt\_result \{}
...
\DoxyCodeLine{321 \textcolor{keyword}{constexpr} \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} codecvt\_result<CodeUnit>::max\_size;}
\DoxyCodeLine{322 }
\DoxyCodeLine{323 \textcolor{keyword}{template} <\textcolor{keyword}{typename} CodeUnit>}
\DoxyCodeLine{324 \textcolor{keywordtype}{void} write\_codecvt(codecvt\_result<CodeUnit>\& out, \mbox{\hyperlink{classbasic__string__view}{string\_view}} in\_buf,}
...
\DoxyCodeLine{464 }
\DoxyCodeLine{465     \textcolor{keywordtype}{bool} handle(detail::null<>) \{}
...
\DoxyCodeLine{473     \textcolor{keywordtype}{bool} fallback(detail::null<>) \{}
...
\DoxyCodeLine{510 }
\DoxyCodeLine{511     \textcolor{keywordtype}{bool} handle(detail::null<>) \{}
...
\DoxyCodeLine{519     \textcolor{keywordtype}{bool} fallback(detail::null<>) \{}
...
\DoxyCodeLine{582   \textcolor{keywordflow}{if} (std::is\_same<Period, std::ratio<1>>::value) \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}s"{}};}
...
\DoxyCodeLine{591   \textcolor{keywordflow}{if} (std::is\_same<Period, std::ratio<60>>::value) \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}m"{}};}
\DoxyCodeLine{592   \textcolor{keywordflow}{if} (std::is\_same<Period, std::ratio<3600>>::value) \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}h"{}};}
...
\DoxyCodeLine{827 \}}
\DoxyCodeLine{828 }
\DoxyCodeLine{829 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Derived> \textcolor{keyword}{struct }null\_chrono\_spec\_handler \{}
...
\DoxyCodeLine{869 \};}
\DoxyCodeLine{870 }
\DoxyCodeLine{871 \textcolor{keyword}{struct }tm\_format\_checker : null\_chrono\_spec\_handler<tm\_format\_checker> \{}
...
\DoxyCodeLine{939 \textcolor{keyword}{struct }has\_member\_data\_tm\_gmtoff : std::false\_type \{\};}
\DoxyCodeLine{940 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{941 \textcolor{keyword}{struct }has\_member\_data\_tm\_gmtoff<T, void\_t<decltype(T::tm\_gmtoff)>>}
...
\DoxyCodeLine{945 \textcolor{keyword}{struct }has\_member\_data\_tm\_zone : std::false\_type \{\};}
\DoxyCodeLine{946 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T>}
\DoxyCodeLine{947 \textcolor{keyword}{struct }has\_member\_data\_tm\_zone<T, void\_t<decltype(T::tm\_zone)>>}
...
\DoxyCodeLine{959 }
\DoxyCodeLine{960 \textcolor{keyword}{template} <\textcolor{keyword}{typename} OutputIt, \textcolor{keyword}{typename} Char> \textcolor{keyword}{class }tm\_writer \{}
...
\DoxyCodeLine{968 }
\DoxyCodeLine{969   \textcolor{keyword}{auto} tm\_sec() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{972   \}}
\DoxyCodeLine{973   \textcolor{keyword}{auto} tm\_min() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{976   \}}
\DoxyCodeLine{977   \textcolor{keyword}{auto} tm\_hour() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{980   \}}
\DoxyCodeLine{981   \textcolor{keyword}{auto} tm\_mday() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{984   \}}
\DoxyCodeLine{985   \textcolor{keyword}{auto} tm\_mon() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{988   \}}
\DoxyCodeLine{989   \textcolor{keyword}{auto} tm\_year() const noexcept -\/> \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \{ \textcolor{keywordflow}{return} 1900ll + tm\_.tm\_year; \}}
\DoxyCodeLine{990   \textcolor{keyword}{auto} tm\_wday() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{993   \}}
\DoxyCodeLine{994   \textcolor{keyword}{auto} tm\_yday() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{997   \}}
\DoxyCodeLine{998 }
\DoxyCodeLine{999   \textcolor{keyword}{auto} tm\_hour12() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{1030   \}}
\DoxyCodeLine{1031   \textcolor{keyword}{auto} tm\_iso\_week\_year() const noexcept -\/> \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} \{}
...
\DoxyCodeLine{1037   \}}
\DoxyCodeLine{1038   \textcolor{keyword}{auto} tm\_iso\_week\_of\_year() const noexcept -\/> \textcolor{keywordtype}{int} \{}
...
\DoxyCodeLine{1044   \}}
\DoxyCodeLine{1045 }
\DoxyCodeLine{1046   \textcolor{keywordtype}{void} write1(\textcolor{keywordtype}{int} value) \{}
\DoxyCodeLine{1047     *out\_++ = \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{char}\textcolor{keyword}{>}(\textcolor{charliteral}{'0'} + to\_unsigned(value) \% 10);}
\DoxyCodeLine{1048   \}}
\DoxyCodeLine{1049   \textcolor{keywordtype}{void} write2(\textcolor{keywordtype}{int} value) \{}
\DoxyCodeLine{1050     \textcolor{keyword}{const} \textcolor{keywordtype}{char}* d = digits2(to\_unsigned(value) \% 100);}
...
\DoxyCodeLine{1129   tm\_writer(\textcolor{keyword}{const} std::locale\& loc, OutputIt out, \textcolor{keyword}{const} std::tm\& tm)}
...
\DoxyCodeLine{1372 \};}
\DoxyCodeLine{1373 }
\DoxyCodeLine{1374 \textcolor{keyword}{struct }chrono\_format\_checker : null\_chrono\_spec\_handler<chrono\_format\_checker> \{}
...
\DoxyCodeLine{1398 \textcolor{keyword}{inline} Int to\_nonnegative\_int(T value, Int upper) \{}
\DoxyCodeLine{1399   FMT\_ASSERT(value >= 0 \&\& to\_unsigned(value) <= to\_unsigned(upper),}
\DoxyCodeLine{1400              \textcolor{stringliteral}{"{}invalid value"{}});}
\DoxyCodeLine{1401   (void)upper;}
\DoxyCodeLine{1402   \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}Int\textcolor{keyword}{>}(value);}
\DoxyCodeLine{1403 \}}
...
\DoxyCodeLine{1405 \textcolor{keyword}{inline} Int to\_nonnegative\_int(T value, Int upper) \{}
\DoxyCodeLine{1406   \textcolor{keywordflow}{if} (value < 0 || value > \textcolor{keyword}{static\_cast<}T\textcolor{keyword}{>}(upper))}
\DoxyCodeLine{1407     FMT\_THROW(\mbox{\hyperlink{classformat__error}{format\_error}}(\textcolor{stringliteral}{"{}invalid value"{}}));}
\DoxyCodeLine{1408   \textcolor{keywordflow}{return} \textcolor{keyword}{static\_cast<}Int\textcolor{keyword}{>}(value);}
\DoxyCodeLine{1409 \}}
\DoxyCodeLine{1410 }
...
\DoxyCodeLine{1423 \textcolor{keyword}{struct }make\_unsigned\_or\_unchanged \{}
\DoxyCodeLine{1424   \textcolor{keyword}{using }type = T;}
\DoxyCodeLine{1425 \};}
\DoxyCodeLine{1426 }
\DoxyCodeLine{1427 \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keyword}{struct }make\_unsigned\_or\_unchanged<T, true> \{}
...
\DoxyCodeLine{1470 \textcolor{keyword}{struct} count\_fractional\_digits \{}
\DoxyCodeLine{1471   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} value =}
\DoxyCodeLine{1472       Num \% Den == 0 ? N : count\_fractional\_digits<Num * 10, Den, N + 1>::value;}
\DoxyCodeLine{1473 \};}
\DoxyCodeLine{1474 }
...
\DoxyCodeLine{1478 \textcolor{keyword}{struct }count\_fractional\_digits<Num, Den, N, false> \{}
\DoxyCodeLine{1479   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{int} value = (Num \% Den == 0) ? N : 6;}
\DoxyCodeLine{1480 \};}
\DoxyCodeLine{1481 }
...
\DoxyCodeLine{1515   \textcolor{keyword}{auto} specs = basic\_format\_specs<Char>();}
...
\DoxyCodeLine{1531   utf8\_to\_utf16 u(unit);}
...
\DoxyCodeLine{1548 \}}
\DoxyCodeLine{1549 }
\DoxyCodeLine{1550 \textcolor{keyword}{class }get\_locale \{}
...
\DoxyCodeLine{1558   get\_locale(\textcolor{keywordtype}{bool} localized, locale\_ref loc) : has\_locale\_(localized) \{}
\DoxyCodeLine{1559     \textcolor{keywordflow}{if} (localized)}
\DoxyCodeLine{1560       ::new (\&locale\_) std::locale(loc.template get<std::locale>());}
\DoxyCodeLine{1561   \}}
\DoxyCodeLine{1562   \string~get\_locale() \{}
...
\DoxyCodeLine{1572 \textcolor{keyword}{struct }chrono\_formatter \{}
...
\DoxyCodeLine{1588   \textcolor{keyword}{using }tm\_writer\_type = tm\_writer<OutputIt, char\_type>;}
\DoxyCodeLine{1589 }
\DoxyCodeLine{1590   chrono\_formatter(FormatContext\& ctx, OutputIt o,}
\DoxyCodeLine{1591                    std::chrono::duration<Rep, Period> d)}
\DoxyCodeLine{1592       : context(ctx),}
\DoxyCodeLine{1593         out(o),}
\DoxyCodeLine{1594         val(static\_cast<rep>(d.count())),}
\DoxyCodeLine{1595         negative(false) \{}
...
\DoxyCodeLine{1654   \}}
\DoxyCodeLine{1655 }
\DoxyCodeLine{1656   \textcolor{keywordtype}{void} write(Rep value, \textcolor{keywordtype}{int} width) \{}
\DoxyCodeLine{1657     write\_sign();}
\DoxyCodeLine{1658     \textcolor{keywordflow}{if} (isnan(value)) \textcolor{keywordflow}{return} write\_nan();}
\DoxyCodeLine{1659     uint32\_or\_64\_or\_128\_t<int> n =}
\DoxyCodeLine{1660         to\_unsigned(to\_nonnegative\_int(value, max\_value<int>()));}
...
\DoxyCodeLine{1669         count\_fractional\_digits<Duration::period::num,}
\DoxyCodeLine{1670                                 Duration::period::den>::value;}
\DoxyCodeLine{1671 }
...
\DoxyCodeLine{1677                         std::chrono::seconds::period>::value) \{}
...
\DoxyCodeLine{1683               \textcolor{keyword}{typename} subsecond\_precision::rep>::value}
...
\DoxyCodeLine{1703     get\_locale loc(localized, context.locale());}
...
\DoxyCodeLine{1774             count\_fractional\_digits<Period::num, Period::den>::value;}
...
\DoxyCodeLine{1838 \textcolor{keyword}{using }weekday = std::chrono::weekday;}
\DoxyCodeLine{1839 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{1840 \textcolor{comment}{// A fallback version of weekday.}}
\DoxyCodeLine{1841 \textcolor{keyword}{class }weekday \{}
\DoxyCodeLine{1842  \textcolor{keyword}{private}:}
\DoxyCodeLine{1843   \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char} value;}
\DoxyCodeLine{1844 }
\DoxyCodeLine{1845  \textcolor{keyword}{public}:}
\DoxyCodeLine{1846   weekday() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{1847   \textcolor{keyword}{explicit} \textcolor{keyword}{constexpr} weekday(\textcolor{keywordtype}{unsigned} wd) noexcept}
\DoxyCodeLine{1848       : value(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{char}\textcolor{keyword}{>}(wd != 7 ? wd : 0)) \{\}}
\DoxyCodeLine{1849   \textcolor{keyword}{constexpr} \textcolor{keywordtype}{unsigned} c\_encoding() const noexcept \{ \textcolor{keywordflow}{return} value; \}}
\DoxyCodeLine{1850 \};}
\DoxyCodeLine{1851 }
\DoxyCodeLine{1852 \textcolor{keyword}{class }year\_month\_day \{\};}
\DoxyCodeLine{1853 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{1854 }
\DoxyCodeLine{1855 \textcolor{comment}{// A rudimentary weekday formatter.}}
\DoxyCodeLine{1856 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }formatter<weekday, Char> \{}
...
\DoxyCodeLine{1862       -\/> \textcolor{keyword}{decltype}(ctx.begin()) \{}
\DoxyCodeLine{1863     \textcolor{keyword}{auto} begin = ctx.begin(), end = ctx.end();}
...
\DoxyCodeLine{1872   \textcolor{keyword}{auto} format(weekday wd, FormatContext\& ctx) \textcolor{keyword}{const} -\/> \textcolor{keyword}{decltype}(ctx.out()) \{}
...
\DoxyCodeLine{1883 \textcolor{keyword}{struct }formatter<std::chrono::duration<Rep, Period>, Char> \{}
\DoxyCodeLine{1884  \textcolor{keyword}{private}:}
\DoxyCodeLine{1885   basic\_format\_specs<Char> specs;}
...
\DoxyCodeLine{2001 \textcolor{keyword}{struct }formatter<std::chrono::time\_point<std::chrono::system\_clock, Duration>,}
\DoxyCodeLine{2002                  Char> : formatter<std::tm, Char> \{}
\DoxyCodeLine{2003   FMT\_CONSTEXPR formatter() \{}
...
\DoxyCodeLine{2009   FMT\_CONSTEXPR \textcolor{keyword}{auto} parse(ParseContext\& ctx) -\/> \textcolor{keyword}{decltype}(ctx.\mbox{\hyperlink{classbasic__format__parse__context_acacc81561f6136973796f6b1ec4bdd5d}{begin}}()) \{}
\DoxyCodeLine{2010     \textcolor{keywordflow}{return} this-\/>do\_parse(ctx.\mbox{\hyperlink{classbasic__format__parse__context_acacc81561f6136973796f6b1ec4bdd5d}{begin}}(), ctx.\mbox{\hyperlink{classbasic__format__parse__context_a624461a9a7da10bd63bb596fb988fc0f}{end}}(), \textcolor{keyword}{true});}
\DoxyCodeLine{2011   \}}
\DoxyCodeLine{2012 }
...
\DoxyCodeLine{2016     \textcolor{keywordflow}{return} formatter<std::tm, Char>::format(localtime(val), ctx);}
\DoxyCodeLine{2017   \}}
\DoxyCodeLine{2018 }
...
\DoxyCodeLine{2024     formatter<std::chrono::time\_point<std::chrono::system\_clock, Duration>,}
\DoxyCodeLine{2025               Char>::default\_specs[];}
\DoxyCodeLine{2026 }
\DoxyCodeLine{2027 \textcolor{keyword}{template} <\textcolor{keyword}{typename} Char> \textcolor{keyword}{struct }formatter<std::tm, Char> \{}
\DoxyCodeLine{2028  \textcolor{keyword}{private}:}
\DoxyCodeLine{2029   \textcolor{keyword}{enum class} spec \{}
\DoxyCodeLine{2030     unknown,}
\DoxyCodeLine{2031     year\_month\_day,}
...
\DoxyCodeLine{2057   FMT\_CONSTEXPR \textcolor{keyword}{auto} parse(ParseContext\& ctx) -\/> \textcolor{keyword}{decltype}(ctx.\mbox{\hyperlink{classbasic__format__parse__context_acacc81561f6136973796f6b1ec4bdd5d}{begin}}()) \{}
\DoxyCodeLine{2058     \textcolor{keywordflow}{return} this-\/>do\_parse(ctx.\mbox{\hyperlink{classbasic__format__parse__context_acacc81561f6136973796f6b1ec4bdd5d}{begin}}(), ctx.\mbox{\hyperlink{classbasic__format__parse__context_a624461a9a7da10bd63bb596fb988fc0f}{end}}());}
\DoxyCodeLine{2059   \}}
\DoxyCodeLine{2060 }
