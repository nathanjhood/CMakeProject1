...
virtual \mbox{\hyperlink{class_test_factory_registry_a1c0c5589eb993ad6a5b1a17d439db457}{$\sim$\+Test\+Factory\+Registry}} ()
...
\index{TestFactoryRegistry@{TestFactoryRegistry}!````~TestFactoryRegistry@{$\sim$TestFactoryRegistry}}
\index{````~TestFactoryRegistry@{$\sim$TestFactoryRegistry}!TestFactoryRegistry@{TestFactoryRegistry}}
\doxysubsubsection{\texorpdfstring{$\sim$TestFactoryRegistry()}{~TestFactoryRegistry()}}
{\footnotesize\ttfamily virtual Test\+Factory\+Registry\+::$\sim$\+Test\+Factory\+Registry (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
