...
# What is it?
Generic CMake Project template for a full CI pipeline, with in-built CMake presets fully tested for a variety of platforms, compilers and architectures, vcpkg package dependancy management, NuGet binary caching, Github Actions workflows and Pages integration, and html documentation generated by doxygen integration; plus a whole lot more still to come.
...
- NuGet package hosting and caching support (via Git)
