...
# What is it?
Generic CMake Project template for a full CI pipeline, with in-built CMake presets, vcpkg package dependancy manager, NuGet binary chacheing, git actions workflows, and html documetation generated by doxygen integration; plus a whole lot more to come.
